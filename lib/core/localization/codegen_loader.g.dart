...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> _ar = {
    ...
    "youWillGetEGP3650PerYearIfYouSubscribeDaily":
        "سوف تحصل على ٣٦٥٠ جنيها في السنه عندما تشترك يوميا",
    ...
    "newBookingsAreWaitingYouGoToResturantDashboardAndExploreMore":
        "الحجوزات الجديدة في الانتظار، سوف تذهب للركاب وتصفح المزيد.",
    ...
    "youHaveSubmittedYourRegistrationSuccessfullyWaitingForAdministrationApproval":
        "تم تقديم التسجيل بنجاح، الان يتم الموافقة عليها من قبل المشرف",
    ...
    "youCanEnjoyServingYourClintsUsingYourRestaurantByClickingOnTheRigesterButtonAbove":
        "يمكنك الاستمتاع بخدمة عملائك باستخدام مطعمك بالضغط على زر التسجيل بالأعلى.",
    ...
    "name": "الاسم",
    "nameMessage":
        "هذا ليس اسم المستخدم أو الرقم السري الخاص بك. سيكون هذا الاسم مرئيًا لجهات اتصال FortyNine الخاصة بك.",
    ...
    "tool_help_question":
        "أنشئ رحلة وأضف رحلتك. انتظر تواصل أصحاب السيارات معك. شارك الرحلة ووفّر المال!",
    "model": "  طراز",
    "publish": "نشر",
    ...
    "expired": "منتهي",
    "youDontOwnCar":
        "أنت لا تمتلك سيارة. شخص ما سيشارك الرحلة معك وادفع نصف السعر.",
    "paymentOption": "نظام الدفع",
    "bookSeat": "حجز مقعد",
    "hoursAgo": "ساعات مضت",
    "daysAgo": "ايام مضت",
    "welcomeToCarPool": "مرحباً بك في مشاركة السيارات",
    "youDontHaveCarMessage":
        "أنت لا تملك سيارة، ستقوم بإنشاء رحلة وتنتظر لمدة ساعة لإعطاء المستخدمين فرصة لحجز مقعد في نفس السيارة.",
    "createRoute": "إنشاء مسار",
    "womenDriverOnly": "سائقات فقط",
    "newRoute": "مسار جديد",
    "youWillFindFewerOption":
        "ستجد عددًا أقل من السائقات إذا اخترت هذا الخيار.",
    ...
    "privacy_settings_info":
        "سيؤثر تغيير إعدادات الخصوصية الخاصة بك على جميع حالاتك.",
    "privacy_settings_help": "مساعدة في إعدادات الخصوصية",
    "choose_who_can_see_status": "اختر من يمكنه رؤية تحديثات حالتك:",
    "my_contacts_info":
        "• جهات الاتصال الخاصة بي: يمكن لجميع جهات الاتصال رؤية حالتك.",
    "my_contacts_except_info":
        "• جهات الاتصال الخاصة بي باستثناء...: حدد جهات الاتصال التي لا تريد أن ترى حالتك.",
    "only_share_with_info":
        "• مشاركة فقط مع...: اختر جهات الاتصال التي تريد مشاركة حالتك معها.",
    ...
    "yourRequestHasBeenSentYouWillReceiveOffersShortly":
        "تم إرسال طلبك. ستتلقى العروض قريبًا.",
    ...
    "applicationDoesNotDeductPercentageFromServiceProvider":
        "التطبيق لا يخصم أي نسبة من مقدم الخدمة.",
    "premiumPackageGivesOpportunityToBeMoreVisible":
        "الباقة المميزة تمنحك فرصة الظهور بشكل أكبر والحصول على استرداد نقدي أكبر.",
    "freeCancellation": "إلغاء مجاني",
    "request": "طلب",
    "driverDashboard": "لوحة القيادة للسائق",
    "newBookingsAreWaitingYou":
        "الحجوزات الجديدة تنتظرك، اذهب إلى لوحة القيادة للسائق واستكشف المزيد!",
    "Call": "اتصال",
    "Message": "رسالة",
    "Report": "تقرير",
    "receiveFawry":
        "طلب بطاقة الصفراء الخاص بك ناجح! تم خصم 50. ستتلقى إشعارًا عندما تكون بطاقتك جاهزة للاستلام في أي فرع من فوري.",
    ...
    "pleaseEnterFrontIdAndBackId":
        "يرجى إدخال الهوية الأمامية والخلفية للاستمرار في طلب البطاقة الصفراء",
    ...
    "successfullyReceiveYourMoneyShortly":
        "لقد قمت بتقديم الدفع بنجاح، تحقق من رصيدك، ستتلقى أموالك قريبًا",
    ...
    "usernameContainLettersNumbersUnderscores":
        "اسم المستخدم يمكن أن يحتوي فقط على حروف، أرقام، وتسطير سفلي",
    ...
    "youCanEnjoyServingYourClientsUsingYourCarByClickingTheRegisterButtonAbove":
        "يمكنك الاستمتاع بخدمة عملائك باستخدام سيارتك عن طريق النقر على زر التسجيل أعلاه.",
    ...
    "subscribeToSendOfferContactTheClient":
        "اشترك لإرسال عرض / التواصل مع العميل",
    ...
    "yellowCardSuccess":
        "لقد قمت بنجاح بإرسال الدفعة للتحقق من رصيد البطاقة الصفراء الخاصة بك.",
    "walletDigital":
        "لقد قمت بإرسال الدفعة بنجاح. تحقق من صندوق الوارد الخاص بك، وسوف تتلقى أموالك قريبًا.",
    "notWalletDigital":
        "لقد قمت بإرسال الدفعة بنجاح. تحقق من صندوق الوارد الخاص بك، وسوف تتلقى قسيمة تتضمن أموالك قريبًا.",
    ...
    "payAtLeast1":
        "ادفع 1 جنيه مصري على الأقل ونشر منتج أحلامك الذي تريد شراءه!!!",
    ...
    "selectValidUser":
        "لم يتم العثور على المستخدم أو أنه غير صالح، يرجى تحديد مستخدم صالح",
    ...
    "premiumPackageMoreVisibilityCashback":
        "تمنحك الباقة المميزة الفرصة لتكون أكثر وضوحًا وتحصل على المزيد من الاسترداد النقدي.",
    "inFront": "من الامام",
    "behind": "من الخلف",
    "drivingLicense": "رخصة القيادة",
    "theApplicationDoesNotDeductAnyPercentage":
        "لا يقوم التطبيق بخصم أي نسبة من مقدم الخدمة.",
    "youWillGetPoundsAnnually":
        "سوف تحصل على 3,650 جنيهًا إسترلينيًا سنويًا إذا قمت بالاشتراك.",
    "license": "رخصة",
    ...
    "Phonenumbercannotbewrittenindescription":
        "لا يمكن كتابه رقم هاتف في الوصف",
    ...
    "atLeast3atMost5items":
        "يرجى اختيار ما لا يقل عن 3 وما لا يزيد عن 5 عناصر.",
    ...
    "service": "خدمى",
    "atLeast3atMost8items":
        "يرجى اختيار ما لا يقل عن 3 وما لا يزيد عن 8 عناصر.",
    ...
    "file": "ملف",
    "enjoyServingClientsUsingCar":
        "يمكنك تقديم خدمات لعملائك باستخدام سيارتك عن طريق الضغط على زر التسجيل أعلاه",
    ...
    "youHaveToUploadThe3PagesOfCommercialRegistration":
        "يجب تحميل الصفحات الثلاث لتسجيل التجاري!",
    ...
    "newTripsAreWaitingYouGoToDriverDashboardAndExploreMore":
        "هناك رحلات جديدة في انتظارك، اذهب إلى لوحة تحكم السائق واكتشف المزيد!",
    ...
    "yourRequestHasBeenSentSuccessfullyWaitingForTheDriverResponse":
        "تم إرسال طلبك بنجاح، في انتظار استجابة السائق",
    ...
    "friendsAndFollowersViewThisPost":
        "يمكن للأصدقاء والمتابعين عرض هذا المنشور",
    ...
    "choosePreferredAppStyle":
        " اختر الآن الشكل المفضل للتطبيق بما يتناسب مع اهتماماتك !!!",
    ...
    "addAde": "اضافة إعلان",
    "cashBack":
        "قم بتحميل فاتورة واحدة على الأقل للاستمتاع بالحصول على استرداد نقدي كهدية من التطبيق",
    "navigateBarDescription":
        "اختر المجال الذي يناسب اهتماماتك في شريط القائمة السفلي. يمكنك اختيار بحد ادنى 3 مجالات وبحد اقصى 5 مجالات.",
    "socialDescription":
        "اختار الشكل الاجتماعي المفضل لديك يمكنك اختيار شكل واحد فقط بحدأقصى",
    "favouriteDescription":
        "اختار الاقسام الرئيسية المفضلة لديك التي تحب أن تراها.  يمكنك اختيار بحد ادنى 3 فئات وبحد اقصى 5 فئات.",
    "warning": "تحذير!!!",
    ...
    "youCanDeActivatePage":
        "يمكنك الغاء تفعيل الصفحه المخصصه و العوده الي الصفحه الرئيسيه من هنا ",
    ...
    "thankYouWeWillRespondWithin24Hours":
        "شكرا لك، سوف نقوم بالرد خلال 24 ساعة",
    "pleaseNoteThatRequestProcessingTakesPlaceDuringBusinessHours":
        "يرجى ملاحظة أن معالجة الطلب تتم خلال ساعات العمل",
    ...
    "allTheInfoAndPicturesAreSavedYouCanContinueAnyTime":
        "تم حفظ كافة المعلومات والصور. يمكنك المتابعة في أي وقت",
    ...
    "toIncludeNearbyPlacesTurnOnLocationServices":
        "لتضمين الأماكن القريبة، فعّل خدمات الموقع",
    ...
    "followedBy": "يتابعه",
    "socialExplain":
        "احصل على المال إذا قمت بالنشر والمشاهدة والإعجاب على أي واجهة تريدها!",
    ...
    "firstImpressionMessage":
        "ارسل رسالة قبل المطابقة للمساعدة في جذب انتباههم. حدد ما الذي جعلهم مميزين، أو قم بتشجيعهم، أو اجعلهم يضحكون.",
    "endToEndDescription":
        "يحافظ التشفير الشامل على رسائلك ومكالماتك الشخصية بينك وبين الأشخاص الذين تختارهم. ولا يمكن حتى لتطبيق 49 قراءة هذه الرسائل أو الاستماع إليها. وهذا يشمل:",
    ...
    "confirmQuantity":
        "اضغط على زر التأكيد لتأكيد الكمية الجديدة أو سنأخذ الكمية القديمة",
    ...
    "phoneNumbersNotAllowed":
        "غير مسموح برقم الهاتف. برجاء حذف رقم الهاتف الموجود",
  ...
  static const Map<String, dynamic> _en = {
    ...
    "newBookingsAreWaitingYouGoToResturantDashboardAndExploreMore":
        "New bookings are waiting. Go to Riders dashboard and explore more.",
    "premium": "Premium",
    "premium2": "Premium",
    ...
    "youCanEnjoyServingYourClintsUsingYourRestaurantByClickingOnTheRigesterButtonAbove":
        "You can enjoy serving your clints using your Rdiers by clicking on the rigester button above.",
    ...
    "pleaseEnterFrontIdAndBackId":
        "Please enter front id and back id to to continue in request yellow card",
    "submitYellowCardRequest": "Submit Yellow Card Request",
    "Other": "other",
    "pleaseEnterYourPhoneNumber": "Please enter your phone number.",
    "invalidPhoneNumber": "Invalid phone number",
    "successfullyReceiveYourMoneyShortly":
        "You have successfully submitted your payment check your balance,you will receive your money shortly",
    ...
    "noPercentageDeductionFromServiceProvider":
        "The application does not deduct any percentage from the service provider.",
    "premiumPackageMoreVisibilityCashback":
    ...
    "theTripHasBeenSuccessfullyClosed":
        "The trip has been successfully closed.",
    ...
    "fillYourDrivingLicenseExpiryDate":
        "fill your driving license expiry date!",
    ...
    "yellowCardSuccess":
        "You have successfully submitted your payment check your yellow card balance.",
    "walletDigital":
        "You have successfully submitted your payment. Check your inbox, you will receive your money shortly.",
    "notWalletDigital":
        "You have successfully submitted your payment. Check your inbox, you will receive a voucher including your money shortly.",
    ...
    "Phonenumbercannotbewrittenindescription":
        "Phone number cannot be written in description",
    ...
    "youHaveToUploadThe3PagesOfCommercialRegistration":
        "You have to upload the 3 pages of commercial registration!",
    ...
    "publishSubmitted":
        "Your talent submitted successfully wait for administration approved",
    ...
    "requestSentSuccess":
        "Your request sent successfully and waiting for approving",
    ...
    "ifUserReachedClick":
        "If the passenger has reached their destination, press the button",
    "reached": "Reached",
    "running": "Running",
    ...
    "sureRecoverDeletedChats":
        "Are you sure you want to recover deleted chats?",
    "marriage": "Marriage",
    "Rating": "Rating:",
    ...
    "choosePreferredAppStyle":
        "Choose now the preferred app style that suits your interests!!!",
    ...
    "addAde": "Add ad",
    "cashBack":
        "Upload At Least One Bill To Enjoy Getting Cash back As A Gift On The App",
    "navigateBarDescription":
        "Choose the field that suits your interests in the bottom menu bar. You can choose a minimum of 3 fields and a maximum of 5 fields.",
    "socialDescription":
        "Choose your preferred social shape. You can select only one shape at most.",
    "favouriteDescription":
        "Choose your favorite main categories that you would like to see. You can choose a minimum of 3 categories and a maximum of 5 categories.",
    ...
    "areYouSureToDeActivate":
        "Are you sure you want to deactivate custom page?",
    "youCanDeActivatePage":
        "You can deactivate the custom page and return to the main page from here",
    ...
    "pleaseNoteThatRequestProcessingTakesPlaceDuringBusinessHours":
        "Please note that request processing takes place during business hours",
    ...
    "weWillNotTellTheDriverYourComments":
        "We will not tell the Driver your Comments",
    ...
    "socialExplain":
        "Get money if you post, view and like on any interface you like!",
    ...
    "firstImpressionMessage":
        "send a message before matching to help get their attention. sat what made them stand out, hype them up, or make them laugh.",
    "endToEndDescription":
        "End to end encryption keeps your personal messages and calls between you and the people you choose. not even 49 app can read or listen to them. this includes your:",
    ...
    "confirmQuantity":
        "Press Confirm button to confirm the new quantity or we will take the old quantity",
    ...
    "youCantChoosePastTime":
        "Please choose a time after a quarter of an hour from now",
    "chooseTheTime": "Time",
    "chooseTheDate": "Date",
    ...
    "uploadingImage": "Uploading Image...",
    "yourRequestHasBeenSentYouWillReceiveOffersShortly":
        "Your request has been sent. You will receive offers shortly.",
    "watch": "Watch",
    "favorite": "Favorite",
