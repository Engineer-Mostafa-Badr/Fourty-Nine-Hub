...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> _ar = {
    ...
    "youHaveToChooseFavoriteSubcategory":
        "يجب عليك اختيار الفئة الفرعية المفضلة!",
    ...
    "youHaveToUploadThe3PagesOfCommercialRegistration":
        "يجب عليك تحميل الصفحات الثلاث لتسجيل التجاري!",
    ...
    "choosePreferredAppStyle":
        "اختار الان الشكل المفضل للتطبيق بما يتناسب مع اهتماماتك !!!",
    ...
    "favouriteDescription":
        "اختار الاقسام الرئيسيه المفضله لديك التي تحب أن تراها.  يمكنك اختيار بحد ادنى 3 فئات وبحد اقصى 8 فئات.",
    "warning": "تحذير!!!",
