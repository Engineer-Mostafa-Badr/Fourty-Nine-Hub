import '../features/account_taps/account/data/datasources/account_remote_datasource.dart';
import '../features/account_taps/account/domain/usecases/delete_favourite_ads_usecase.dart';
import '../features/account_taps/account/domain/usecases/get_favourite_ads_usecase.dart';
import '../features/account_taps/account/domain/usecases/get_favourite_categories_usecase.dart';
import '../features/account_taps/account/domain/usecases/get_favourite_subcategories_usecase.dart';
import '../features/account_taps/account/presentation/cubit/managers/favourite_categories_cubit.dart';
import '../features/account_taps/lists/data/datasources/lists_remote_datasource.dart';
import '../features/account_taps/lists/data/repositories/lists_repo_impl.dart';
import '../features/account_taps/lists/domain/repositories/lists_repo.dart';
import '../features/account_taps/lists/domain/usecases/get_blocked_usecase.dart';
import '../features/account_taps/lists/domain/usecases/get_followers_usecase.dart';
import '../features/account_taps/lists/domain/usecases/get_friend_requests_usecase.dart';
import '../features/account_taps/lists/domain/usecases/get_friends_usecase.dart';
import '../features/account_taps/wallet/data/datasources/Gift/gift_remote_data_source.dart';
import '../features/account_taps/wallet/data/datasources/wallet_remote_datasource.dart';
import '../features/account_taps/wallet/data/repositories/Gift/gift_repository_impl.dart';
import '../features/account_taps/wallet/data/repositories/wallet_repo_impl.dart';
import '../features/account_taps/wallet/domain/repositories/gift_repository.dart';
import '../features/account_taps/wallet/domain/repositories/wallet_repo.dart';
import '../features/account_taps/wallet/domain/usecases/delete_subscription_use_case.dart';
import '../features/account_taps/wallet/domain/usecases/get_balance_history_use_case.dart';
import '../features/account_taps/wallet/domain/usecases/get_balance_use_case.dart';
import '../features/account_taps/wallet/domain/usecases/get_wallet_gifts_use_case.dart';
import '../features/account_taps/wallet/domain/usecases/get_wallet_usecase.dart';
import '../features/account_taps/wallet/domain/usecases/get_winners_gift_use_case.dart';
import '../features/account_taps/wallet/domain/usecases/request_withdraw_use_case.dart';
import '../features/account_taps/wallet/domain/usecases/request_withdraw_wallet_use_case.dart';
import '../features/account_taps/wallet/domain/usecases/request_withdraw_wheel_use_case.dart';
import '../features/account_taps/wallet/presentation/cubit/Gift_Cubit/gift_cubit.dart';
import '../features/account_taps/wallet/presentation/cubit/charge_wallet_cubit/charge_wallet_cubit.dart';
import '../features/account_taps/wallet/presentation/cubit/cashback_cubit/cashback_cubit.dart';
import '../features/account_taps/wallet/presentation/cubit/fetch_sub_category_wallet/fetch_sub_category_wallet_cubit.dart';
import '../features/account_taps/wallet/presentation/cubit/gift_two_cubit/gift_two_cubit.dart';
...
class AccountServiceLocator {
  static Future<void> execute({required GetIt serviceLocator}) async {
    ...
    serviceLocator
        .registerFactory<FavouriteCategoryCubit>(() => FavouriteCategoryCubit(
              serviceLocator(),
              serviceLocator(),
              serviceLocator(),
            ));
