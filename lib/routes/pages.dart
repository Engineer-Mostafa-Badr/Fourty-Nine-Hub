...
import '../features/RideFeature/data/models/trip_receipt.dart';

import '../features/RideFeature/presentation/controllers/ride_register/ride_register_cubit.dart';
import '../features/RideFeature/presentation/pages/Register/Driver/creminal_record_screen.dart';
import '../features/RideFeature/presentation/pages/Register/Driver/drug_analysis.dart';
import '../features/RideFeature/presentation/pages/Register/Driver/technical_examination_screen.dart';
import '../features/RideFeature/presentation/pages/Register/Driver/upload_rider_images.dart';
import '../features/RideFeature/presentation/pages/activity_trip_screen.dart';
import '../features/RideFeature/presentation/pages/complete_ride_screen.dart';
import '../features/RideFeature/presentation/pages/dashboards/ride_mode_screen.dart';
import '../features/RideFeature/presentation/pages/expired_trips_screen.dart';
import '../features/RideFeature/presentation/pages/gmap_search_and_pick.dart';
import '../features/RideFeature/presentation/pages/gmap_search_and_pick_screen.dart';
import '../features/RideFeature/presentation/pages/history_trips_screen.dart';
import '../features/RideFeature/presentation/pages/rating_driver_screen.dart';
import '../features/RideFeature/presentation/pages/ride_arrived_screen.dart';
import '../features/RideFeature/presentation/pages/ride_history_details_screen.dart';
import '../features/RideFeature/presentation/pages/running_trips_screen.dart';
import '../features/RideFeature/presentation/pages/support_screen/emergency_contacts_screen.dart';
import '../features/RideFeature/presentation/pages/support_screen/support_client_details_screen.dart';
import '../features/RideFeature/presentation/pages/support_screen/support_ride_screen.dart';
import '../features/account_taps/account/presentation/pages/favourite_view.dart';
import '../features/account_taps/contact_us/presentation/cubit/contact_us_cubit.dart';
import '../features/account_taps/contact_us/presentation/pages/contact_us_view.dart';
import '../features/account_taps/lists/presentation/pages/lists_view.dart';
import '../features/account_taps/my_adds/presentation/cubit/my_adds_cubit.dart';
import '../features/account_taps/privacy/presentation/pages/privacy_view.dart';
import '../features/account_taps/share_app/presentation/pages/share_the_app.dart';
import '../features/account_taps/wallet/domain/entities/wallet_history_entity.dart';
import '../features/account_taps/wallet/presentation/cubit/Balance_Cubit/balance_cubit.dart';
import '../features/account_taps/wallet/presentation/cubit/wallet_cubit.dart';
import '../features/account_taps/wallet/presentation/cubit/wallet_two_cubit/wallet_two_cubit.dart';
import '../features/account_taps/wallet/presentation/cubit/winners_cashback_cubit/winners_cashback_cubit.dart';
import '../features/account_taps/wallet/presentation/cubit/winners_gift_cubit/winners_gift_cubit.dart';
import '../features/account_taps/wallet/presentation/pages/balance_wallet_view.dart';
import '../features/account_taps/wallet/presentation/pages/cashback_view.dart';
import '../features/account_taps/wallet/presentation/pages/gift_view.dart';
import '../features/account_taps/wallet/presentation/pages/winners_gift_view.dart';
import '../features/ads_feature/ad_details/presentation/cubit/ad_details_cubit.dart';
import '../features/ads_feature/ad_requests/presentation/cubit/ad_requests_cubit.dart';
import '../features/ads_feature/ads/presentation/cubit/ads_cubit.dart';
import '../features/ads_feature/ads/presentation/pages/ads_view.dart';
import '../features/ads_feature/ads/presentation/pages/marriage_ads_view.dart';
import '../features/ads_feature/create_ad/presentation/pages/create_ad.dart';
import '../features/ads_feature/create_company_ad/presentation/cubit/create_company_ad_cubit.dart';
import '../features/ads_feature/create_company_ad/presentation/pages/create_post_reel_company.dart';
import '../features/ads_feature/create_company_ad/presentation/pages/create_posts_company.dart';
import '../features/ads_feature/filter_ads/presentation/pages/filter_ads.dart';
import '../features/ads_feature/filter_ads/presentation/pages/governorate_filter_ads.dart';
...
import '../features/azkaar/presentation/pages/azkar_details.dart';
import '../features/carpool/add_new_route/presentation/cubits/destination_location_carpool/cubit/map_box_dest_cubit_cubit.dart';
import '../features/carpool/add_new_route/presentation/cubits/get_llat_and_long/cubit/cubit/dest_get_lat_and_long_cubit.dart';
import '../features/carpool/add_new_route/presentation/cubits/get_llat_and_long/cubit/get_lat_and_long_cubit.dart';
import '../features/carpool/add_new_route/presentation/cubits/get_price_carpool/get_price_carpool_cubit.dart';
import '../features/carpool/add_new_route/presentation/cubits/here_cubit/cubit/here_location_cubit.dart';
import '../features/carpool/add_new_route/presentation/cubits/mapBox_cubit/cubit/map_box_cubit_cubit.dart';
import '../features/carpool/add_new_route/presentation/cubits/verify_complet_driver/cubit/verify_complete_driver_cubit.dart';
import '../features/carpool/add_new_route/presentation/views/add_new_route_view.dart';
import '../features/carpool/avaliable_routes/presentation/cubits/accept_trip/cubit/accept_trip_for_driver_cubit.dart';
import '../features/carpool/avaliable_routes/presentation/cubits/cubit/get_all_trips_cubit.dart';
import '../features/carpool/avaliable_routes/presentation/cubits/get_available_trips_for_drivers/cubit/get_available_trips_for_drivers_cubit.dart';
import '../features/carpool/avaliable_routes/presentation/cubits/get_currency/cubit/get_currency_cubit.dart';
import '../features/carpool/avaliable_routes/presentation/views/carpool_view.dart';
import '../features/carpool/create_carpool/presentation/cubits/cubit/create_car_pool_cubit.dart';
import '../features/carpool/join_trip/presentation/cubits/cubit/join_trip_car_pool_cubit.dart';
import '../features/custom_page/presentation/page/custom_page.dart';
import '../features/custom_page/presentation/page/widget/page_preview.dart';
...
import '../features/food_feature/edit_food/presentation/pages/edit_food_view.dart';
import '../features/food_feature/restaurant_dashboard/presentation/cubit/restaurant_dashboard_cubit.dart';
import '../features/food_feature/restaurant_dashboard/presentation/pages/restaurant_dashboard_view.dart';
import '../features/food_feature/restaurants_list/domain/entities/restaurant.dart';
import '../features/food_feature/restaurants_list/presentation/cubit/create_resturant_cubit.dart';
import '../features/food_feature/restaurants_list/presentation/pages/create_resturant_view.dart';
import '../features/fourty_nine/domain/entities/main_category_entity.dart';
import '../features/fourty_nine/presentation/controllers/main_categories_taps_cubit/main_categories_taps_cubit.dart';
...
import '../features/health_feature/booking/presentation/pages/all_appointments_screen.dart';
import '../features/health_feature/create_doctor/presentation/cubit/create_doctor_cubit.dart';
import '../features/health_feature/create_doctor/presentation/pages/create_doctor_view.dart';
...
import '../features/health_feature/doctor_dashboard/presentation/pages/all_doctor_reservations_view.dart';
import '../features/health_feature/doctor_dashboard/presentation/pages/doctor_dashboard_view.dart';
import '../features/health_feature/doctor_dashboard/presentation/pages/doctor_statistics.dart';
import '../features/health_feature/doctor_dashboard/presentation/pages/edit_doctor_personal_info_view.dart';
import '../features/health_feature/doctor_dashboard/presentation/pages/edit_doctor_profile.dart';
import '../features/health_feature/doctor_dashboard/presentation/pages/edit_doctor_timetable_view.dart';
import '../features/health_feature/doctor_dashboard/presentation/pages/today_doctor_appointments_view.dart';
import '../features/health_feature/doctor_dashboard/presentation/pages/unhandled_doctor_appointments_view.dart';
import '../features/health_feature/doctor_dashboard/presentation/widgets/edit_time_table/time_table_options_checkbox.dart';
import '../features/health_feature/doctor_details/domain/entities/doctor_entity.dart';
import '../features/health_feature/doctor_details/presentation/pages/all_reviews.dart';
...
import '../features/health_feature/doctor_filter/presentation/pages/citiy_filter_view.dart';
import '../features/health_feature/doctor_filter/presentation/pages/governorate_filter_view.dart';
import '../features/health_feature/doctor_filter/presentation/pages/subcategory_filter_view.dart';
...
import '../features/health_feature/emergency/presentation/pages/emergency_requests_view.dart';
import '../features/health_feature/emergency/presentation/pages/emergnce_view.dart';
import '../features/health_feature/health/domain/entities/earned_mony_entity.dart';
...
import '../features/married/presentation/pages/married_view.dart';
...
import '../features/new_trip_join/captainshare/screen/route_details_screen.dart';
...
import '../features/new_trip_join/domain/entities/my_booking_entity.dart';
...
import '../features/notifications/presentation/cubits/all_notifications_seen/all_notfications_seen_cubit.dart';
import '../features/notifications/presentation/cubits/delete_all_notifications/delete_all_notifications_cubit.dart';
import '../features/notifications/presentation/cubits/delete_notification/delete_notification_cubit.dart';
import '../features/notifications/presentation/cubits/notification_seen/notification_seen_cubit.dart';
import '../features/payment/presentation/cubit/payment_cubit.dart';
import '../features/quraan/presentation/cubit/quraan_cubit.dart';
import '../features/requests_history/presentation/cubit/request_history_ride_cubit.dart';
import '../features/requests_history/presentation/pages/requests_history_view.dart';
import '../features/ride/RideRequest/data/models/check_accept_by_rider_model/check_accept_by_rider_model.dart';
import '../features/ride/RideRequest/data/models/check_accept_trip_from_driver_model/check_accept_trip_from_driver_model.dart';
import '../features/ride/RideRequest/data/models/review_ride_trip_model.dart';
import '../features/ride/RideRequest/presentation/cubit/CarInfo/get_car_brand_ride_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/CarInfo/get_car_colors_ride_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/CarInfo/get_car_model_by_brand_ride_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/CarInfo/get_car_year_by_model_ride_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/CarInfo/select_car_model_brand_year_ride_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/NoSocket/accept_offer_no_socket_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/NoSocket/decline_offer_no_socket_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/NoSocket/delete_offer_ride_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/NoSocket/get_all_trip_no_socket_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/NoSocket/get_trip_offers_no_socket_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/NoSocket/get_user_login_trip_no_socket_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/NoSocket/offer_no_socket_actions_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/NoSocket/send_offer_no_socket_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/TripCubit/cancel_trip_client_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/TripCubit/cancel_trip_rider_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/TripCubit/completed_trip_rider_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/TripCubit/partial_payment_rider_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/TripCubit/rider_in_start_location_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/change_driver_status_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/check_driver_type_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/create_trip_request_ride_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/delete_driver_ride_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/get_cateogry_rider_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/get_destination_point_ride_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/get_driver_info_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/get_driver_info_shipping_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/get_driver_ride_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/get_expired_trip_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/get_location_from_lat_lng_ride_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/get_reasons_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/get_route_rider_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/get_starting_point_ride_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/get_trip_info_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/picture_optional_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/raise_fare_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/request_rider_trip_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/rider_trip_reel_time_cubit.dart';
import '../features/ride/RideRequest/presentation/cubit/select_cateogry_cubit.dart';
import '../features/ride/RideRequest/presentation/pages/all_rider_trip_screen.dart';
import '../features/ride/RideRequest/presentation/pages/all_trip_no_socket_screen.dart';
import '../features/ride/RideRequest/presentation/pages/register_ride_parts_screen.dart';
import '../features/ride/RideRequest/presentation/pages/rider_register_view.dart';
import '../features/ride/RideRequest/presentation/pages/shipping_rider_tab_screen.dart';
import '../features/ride/RideRequest/presentation/pages/trip_info_by_driver_screen.dart';
import '../features/ride/RideRequest/presentation/pages/trip_info_by_rider_screen.dart';
import '../features/ride/RideRequest/presentation/pages/trip_rating_ride_screen.dart';
import '../features/ride/RideRequest/presentation/pages/update_driver_ride_screen.dart';
import '../features/ride/RideRequest/presentation/pages/update_driver_shipping_screen.dart';
...
import '../features/settings/presentation/pages/change_password_second_view.dart';
import '../features/settings/presentation/pages/change_password_view.dart';
import '../features/settings/presentation/pages/settings_view.dart';
import '../features/settings/presentation/pages/verification_view.dart';
import '../features/shipping/create_shipping_request/data/models/get_requests_for_loading_model/get_requests_for_loading_model.dart';
...
import '../features/shipping/create_shipping_request/presentation/pages/create_shipping_view.dart';
import '../features/shipping/create_shipping_request/presentation/pages/dahsboard_driver_screen.dart';
import '../features/shipping/create_shipping_request/presentation/pages/register_shipping_screen.dart';
import '../features/shipping/create_shipping_request/presentation/pages/trip_rating_screen.dart';
import '../features/social_media/chat/broadcasts/presentation/pages/broadcast_view.dart';
import '../features/social_media/chat/broadcasts/presentation/pages/see_all_broadcasts.dart';
import '../features/social_media/chat/chat_profile/presentation/pages/chat_profile_view.dart';
import '../features/social_media/chat/chat_room/domain/entities/message_entity.dart';
import '../features/social_media/chat/chat_room/presentation/controllers/chat_room_cubit/chat_room_cubit.dart';
import '../features/social_media/chat/chat_room/presentation/pages/attachments_view.dart';
import '../features/social_media/chat/chat_room/presentation/pages/camera_picker/camera_picker.dart';
import '../features/social_media/chat/chat_room/presentation/pages/chat_room_view.dart';
import '../features/social_media/chat/chat_room/presentation/pages/contacts_view.dart';
import '../features/social_media/chat/chat_room/presentation/pages/forward_messages_view.dart';
import '../features/social_media/chat/chat_room/presentation/pages/one_time_document_message.dart';
import '../features/social_media/chat/chat_room/presentation/pages/one_time_voice_message_view.dart';
import '../features/social_media/chat/chat_room/presentation/pages/select_contacts_to_share_view.dart';
import '../features/social_media/chat/chat_room/presentation/pages/show_image_view.dart';
import '../features/social_media/chat/chat_room/presentation/pages/show_images_view.dart';
import '../features/social_media/chat/chat_room/presentation/pages/viewcontact_view.dart';
import '../features/social_media/chat/chat_view/presentation/chat_cubit/chats_cubit.dart';
import '../features/social_media/chat/chat_view/presentation/pages/archived_chats_view.dart';
...
import '../features/social_media/club_house/presentation/widgets/components/create_voice_room_sheet.dart';
import '../features/social_media/create_post/domain/entities/life_event_entity.dart';
import '../features/social_media/create_post/presentation/pages/life_event_sub_categories.dart';
import '../features/social_media/edit_profile/presentation/cubit/edit_profile_cubit.dart';
import '../features/social_media/edit_profile/presentation/pages/edit_profile_view.dart';
import '../features/social_media/instagram/presentation/cubit/Post/get_posts_instagram_cubit.dart';
import '../features/social_media/instagram/presentation/cubit/create_post_instagram_cubit/create_post_instagram_cubit.dart';
import '../features/social_media/instagram/presentation/cubit/follow_requests_instagram_cubit/follow_requests_instagram_cubit.dart';
import '../features/social_media/instagram/presentation/cubit/instagram_add_location_cubit/instagram_add_location_cubit.dart';
import '../features/social_media/instagram/presentation/cubit/instagram_add_music_cubit/instagram_add_music_cubit.dart';
import '../features/social_media/instagram/presentation/cubit/instagram_cubit.dart';
import '../features/social_media/instagram/presentation/cubit/profile_instagram_cubit/profile_instagram_cubit.dart';
import '../features/social_media/instagram/presentation/cubit/single_post_instagram_cubit/single_post_instagram_cubit.dart';
import '../features/social_media/instagram/presentation/cubit/tag_users_cubit/tag_users_cubit.dart';
import '../features/social_media/instagram/presentation/pages/add_story_view.dart';
import '../features/social_media/instagram/presentation/pages/comment_instagram_view.dart';
import '../features/social_media/instagram/presentation/pages/create_post_instagram_view.dart';
import '../features/social_media/instagram/presentation/pages/create_post_second_page_instagram_view.dart';
import '../features/social_media/instagram/presentation/pages/follow_requests_instagram_view.dart';
import '../features/social_media/instagram/presentation/pages/instagram_add_location_view.dart';
import '../features/social_media/instagram/presentation/pages/instagram_add_music_view.dart';
import '../features/social_media/instagram/presentation/pages/instgram_view.dart';
import '../features/social_media/instagram/presentation/pages/profile_instagram_view.dart';
import '../features/social_media/instagram/presentation/pages/single_post_instagram_view.dart';
import '../features/social_media/instagram/presentation/widgets/instagram_all_discover_people.dart';
import '../features/social_media/instagram/presentation/widgets/tag_user_view.dart';
import '../features/social_media/live_streaming/presentation/pages/live_stream_home_screen.dart';
import '../features/social_media/live_streaming/presentation/pages/live_stream_view.dart';
import '../features/social_media/reels/presentation/controllers/explore_reels_cubit/reel_cubit.dart';
import '../features/social_media/reels/presentation/pages/main_reel_view.dart';
import '../features/social_media/reels/presentation/pages/music_reels.dart';
import '../features/social_media/snap/presentation/pages/snap_view.dart';
import '../features/social_media/social_posts/presentation/widgets/facebook_widgets/face_book_post_details.dart';
import '../features/social_media/social_posts/presentation/widgets/facebook_widgets/facebook_suggest_people.dart';
import '../features/social_media/spot_light/presentation/pages/spotlight_view.dart';
import '../features/social_media/stories/presentation/cubit/stories_cubit.dart';
import '../features/social_media/tinder/presentation/pages/my_profile.dart';
import '../features/social_media/tinder/presentation/pages/tinder_view.dart';
import '../features/social_media/tinder/presentation/pages/user_profile.dart';
import '../features/social_media/tinder/presentation/widgets/edit_profile_tinder.dart';
...
import '../features/star_feature/presentation/pages/all_winner_view.dart';
import '../features/star_feature/presentation/pages/be_star_view.dart';
import '../features/subcategories/presentation/pages/subcategories_view.dart';
...
import '../features/ten_percent/presentation/pages/ten_percent_view.dart';
import '../features/ten_percent/presentation/pages/winners_ten_percent_view.dart';
import '../features/trip_join/add_new_pick_me/presentation/cubits/cubit/add_new_pick_me_trip_cubit.dart';
import '../features/trip_join/add_new_pick_me/presentation/views/add_new_pick_me_view.dart';
import '../features/trip_join/add_new_trip_join/domain/usecases/fetch_car_brand_usecase.dart';
import '../features/trip_join/add_new_trip_join/domain/usecases/fetch_car_model_usecase.dart';
import '../features/trip_join/add_new_trip_join/domain/usecases/fetch_car_year_type_usecase.dart';
import '../features/trip_join/add_new_trip_join/domain/usecases/fetch_location_cordinates_usecase.dart';
import '../features/trip_join/add_new_trip_join/domain/usecases/fetch_price_distance_usecase.dart';
import '../features/trip_join/add_new_trip_join/domain/usecases/publish_trip_join_usecase.dart';
import '../features/trip_join/add_new_trip_join/presentation/cubits/destination_location/destination_location_cubit.dart';
import '../features/trip_join/add_new_trip_join/presentation/cubits/fetch_car_brands/fetch_car_brands_cubit.dart';
import '../features/trip_join/add_new_trip_join/presentation/cubits/fetch_car_models/fetch_car_models_cubit.dart';
import '../features/trip_join/add_new_trip_join/presentation/cubits/fetch_car_year_type/fetch_car_year_type_cubit.dart';
import '../features/trip_join/add_new_trip_join/presentation/cubits/fetch_price_distance/fetch_price_distance_cubit.dart';
import '../features/trip_join/add_new_trip_join/presentation/cubits/publish_trip_join/publish_trip_join_cubit.dart';
import '../features/trip_join/add_new_trip_join/presentation/cubits/starting_location/starting_location_cubit.dart';
import '../features/trip_join/add_new_trip_join/presentation/cubits/trip_join_view/trip_join_view_cubit.dart';
import '../features/trip_join/get_requests_pick_me/data/models/get_requests_pick_me_model.dart';
import '../features/trip_join/get_requests_pick_me/presentation/cubits/cubit/get_requests_pick_me_cubit.dart';
import '../features/trip_join/get_requests_pick_me/presentation/views/get_requests_pick_me_view.dart';
import '../features/trip_join/notifications/presentation/views/request_trip_join_notification.dart';
import '../features/trip_join/trip_join_requests_history/presentation/cubits/get_request/get_request_cubit.dart';
import '../features/trip_join/trip_join_requests_history/presentation/pages/tripjoin_request_history_view.dart';
import '../features/trip_join/view_all_pick_me/domain/usecases/view_all_pick_me_usecase.dart';
import '../features/trip_join/view_all_pick_me/presentation/cubits/view_all_pick_me/view_all_pick_me_cubit.dart';
import '../features/trip_join/view_all_trip_join/domain/usecases/request_trip_join_usecase.dart';
import '../features/trip_join/view_all_trip_join/presentation/cubits/request_trip_join_cubit/request_trip_join_cubit.dart';
import '../features/trip_join/view_all_trip_join/presentation/cubits/view_all_trip_join_cubit/view_all_trip_join_cubit.dart';
import '../features/trip_join/view_all_trip_join/presentation/views/trip_join_create_ad_view.dart';
import '../features/zoom/presentation/controller/stream_cubit.dart';
import '../features/zoom/presentation/widgets/join_meeting_screen.dart';
import '../main.dart';
          ...
          GoRoute(
            ...
            routes: [
              ...
              GoRoute(
                ...
                builder: (context, state) => const RideArrivedScreen(),
              ),
              GoRoute(
