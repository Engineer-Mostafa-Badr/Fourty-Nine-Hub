                ...
                GoRoute(
                  ...
                  routes: [
                    ...
                    GoRoute(
                      ...
                      pageBuilder: (context, state) => customTransition(
                          context, state, const ChooseLangScreen()),
                    ),
                    GoRoute(
                    ...
                    GoRoute(
                      ...
                      pageBuilder: (context, state) => customTransition(
                        ...
                        state,
                        RunningTripScreen(
                            params: state.extra as RunningTripParams),
                      ),
                    ),
                    GoRoute(
                    ...
                    GoRoute(
                      ...
                      pageBuilder: (context, state) => customTransition(
                        ...
                        RideOpenStreetMapSearchAndPick(
                          params: state.extra
                              as RideOpenStreetMapSearchAndPickParams,
                        ),
                      ),
                    ),
                    GoRoute(
                      ...
                      pageBuilder: (context, state) => customTransition(
                        ...
                        RideOpenGoogleMapSearchAndPickScreen(
                          params:
                              state.extra as RideGoogleMapSearchAndPickParams,
                        ),
                      ),
                    ),
                    GoRoute(
                      ...
                      pageBuilder: (context, state) => customTransition(
                        ...
                        BlocProvider.value(
                          ...
                          child: CustomPageSubCategoriesView(
                            params:
                                state.extra as CustomPageSubCategoriesParams,
                          ),
                        ),
                      ),
                    ),
                      ...
                      pageBuilder: (context, state) => customTransition(
                        ...
                        MultiBlocProvider(
                          providers: [
                            ...
                            BlocProvider(
                              create: (_) =>
                                  serviceLocator<GiftCubit>()..loadData(),
                            ),
                          ],
                          child: LoginView(
                    ...
                    GoRoute(
                      ...
                      pageBuilder: (context, state) => customTransition(
                        ...
                        BlocProvider(
                          create: (context) =>
                              serviceLocator<WinnersCashbackCubit>()
                                ..getWinners(context),
                    ...
                    GoRoute(
                      ...
                      pageBuilder: (context, state) => customTransition(
                        ...
                        BlocProvider(
                          create: (context) =>
                              serviceLocator<WinnersGiftCubit>()
                                ..getWinners(context),
                    ...
                    GoRoute(
                        ...
                        routes: [
                          GoRoute(
                              ...
                              pageBuilder: (context, state) {
                                final item =
                                    state.extra as List<WalletHistoryEntity>;
                                return customTransition(
                                    context,
                                    state,
                                    WalletHistory(
                    ...
                    GoRoute(
                      ...
                      pageBuilder: (context, state) => customTransition(
                        ...
                        BlocProvider(
                          create: (context) =>
                              serviceLocator<ForgotPasswordCubit>(),
                          child: VerificationView(
                            questions:
                                state.extra as ForgetPasswordQuestionsEntity,
                          ),
                        ),
                      ),
                    ),
                        ...
                        routes: [
                          ...
                          GoRoute(
                            ...
                            pageBuilder: (context, state) => customTransition(
                                ...
                                BlocProvider<ShareAppCubit>(
                                  create: (_) => serviceLocator<ShareAppCubit>()
                                    ..shareApp(),
                          ...
                          GoRoute(
                            ...
                            pageBuilder: (context, state) => customTransition(
                                ...
                                BlocProvider.value(
                                    value:
                                        serviceLocator<FavouriteDrawerCubit>(),
                                  ...
                                  pageBuilder: (context, state) =>
                                      customTransition(
                                          ...
                                          BlocProvider<CreateAdCubit>(
                                            create: (_) => serviceLocator(),
                                            child: EditMyAds(
                                              categorization: state.extra
                                                  as MyAuctionAdsEntity,
                                            ),
                                          ))),
                            ],
                            pageBuilder: (context, state) => customTransition(
                    ...
                    GoRoute(
                        ...
                        routes: [
                          ...
                          GoRoute(
                            ...
                            pageBuilder: (context, state) {
                              return customTransition(
                                  ...
                                  CreateLifeEvent(
                                    lifeEventData:
                                        state.extra as LifeEventEntity,
                                  ));
                            },
                          ),
                          GoRoute(
                          ...
                          GoRoute(
                            ...
                            name: Routes.Tinder,
                            pageBuilder: (context, state) => customTransition(
                                context, state, const TinderView()),
                          ),
                          GoRoute(
                          ...
                          GoRoute(
                            ...
                            pageBuilder: (context, state) => customTransition(
                                ...
                                BlocProvider<DoctorUnhandledAppointmentsCubit>(
                                  create: (context) => serviceLocator(),
                                  child:
                                      const DoctorUnhandledAppointmentsView(),
                                )),
                          ),
                          GoRoute(
                              ...
                              pageBuilder: (context, state) => customTransition(
                                    ...
                                    BlocProvider(
                                      ...
                                      child: RestaurantDetailsView(
                                        restaurant: state.extra
                                            as GetAllRestaurantEntity,
                                      ),
                                    ),
                                  ),
                              routes: [
                          ...
                          return customTransition(
                              ...
                              MultiBlocProvider(
                                providers: [
                                  ...
                                  BlocProvider(
                                    create: (context) =>
                                        GetStartingPointRideCubit(
                                            repository: serviceLocator()),
                                  ),
                                  BlocProvider(
                                    create: (context) =>
                                        GetDestinationPointRideCubit(
                                            repository: serviceLocator()),
                                  ),
                                  BlocProvider(
                                    create: (context) => GetTripInfoCubit(
                    ...
                    GoRoute(
                      ...
                      pageBuilder: (context, state) => customTransition(
                        ...
                        MultiBlocProvider(providers: [
                          ...
                          BlocProvider(
                            create: (context) =>
                                serviceLocator<CreateDoctorCubit>(),
                          ),
                          BlocProvider(
                      ...
                      pageBuilder: (context, state) => customTransition(
                          ...
                          MultiBlocProvider(
                            providers: [
                              ...
                              BlocProvider(
                                create: (context) => GetAllTripCubit(
                                    repository: serviceLocator()),
                              ),
                              BlocProvider(
                                create: (context) => CallMessageCubit(
                      ...
                      pageBuilder: (context, state) => customTransition(
                          ...
                          MultiBlocProvider(
                            ...
                            child: TripRatingScreen(
                                model:
                                    state.extra as GetRequestsForLoadingModel),
                          )),
                    ),
                      ...
                      pageBuilder: (context, state) => customTransition(
                          ...
                          BlocProvider<GetRequestsPickMeCubit>(
                            ...
                            child: GetRequestsPickMeView(
                              pickMeRequests:
                                  state.extra as List<PickMeRequest>,
                            ),
                          )),
                    ),
                    GoRoute(
                        ...
                        return customTransition(
                            ...
                            BlocProvider(
                                ...
                                child: PersonalInformationScreen(
                                  params:
                                      state.extra as RideFeatureRegisterParams,
                                )));
                      },
                    ),
                    GoRoute(
                        ...
                        return customTransition(
                            ...
                            MultiBlocProvider(
                                ...
                                child: DriversLicenseScreen(
                                  params:
                                      state.extra as UploadRiderImagesParams,
                                )));
                      },
                    ),
                    GoRoute(
                    ...
                    GoRoute(
                      ...
                      pageBuilder: (context, state) => customTransition(
                          ...
                          BlocProvider(
                            create: (context) =>
                                serviceLocator<ClientTripsCubit>()
                      ...
                      pageBuilder: (context, state) => customTransition(
                          ...
                          MultiBlocProvider(
                            ...
                            child: LoadingDashboardDetailsScreen(
                                tripEntity:
                                    state.extra as GetLoadingHistoryEntity),
                          )),
                    ),
                    GoRoute(
                      path: Paths.CHANCE,
