        ...
        routes: <RouteBase>[
          ...
          GoRoute(
            ...
            builder: (context, state) => BlocProvider(
                create: (context) => serviceLocator<MainCategoriesTapsCubit>(), child: MainCategoriesGridView()),
          ),
          GoRoute(
          ...
          GoRoute(
              ...
              routes: [
                ...
                GoRoute(path: Paths.POLICY, name: Routes.POLICY, builder: (context, state) => PolicyView()),
                GoRoute(
                    path: Paths.Lists,
                    name: Routes.Lists,
