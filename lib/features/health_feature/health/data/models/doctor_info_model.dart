...
class DoctorInfoModel extends DoctorInfoEntity {
  DoctorInfoModel({required super.remainingDaysToExpiryId, required super.remainingDaysToExpiryPracticingId, required super.remainingDaysToEndSubscription,required super.totalEarnedMoney});
