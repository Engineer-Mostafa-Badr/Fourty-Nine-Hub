...
import 'package:fourtyninehub/features/health_feature/fast_booking/presentation/controllers/subcategory_filter_cubit/doctor_filter_cubit.dart';
import 'package:fourtyninehub/features/health_feature/fast_booking/presentation/widgets/subcategories_list.dart';
...
class DoctorSubcategoryFilterView extends StatefulWidget {
  ...
  @override
  State<DoctorSubcategoryFilterView> createState() =>
      _DoctorSubcategoryFilterViewState();
}

class _DoctorSubcategoryFilterViewState
    extends State<DoctorSubcategoryFilterView> {
  @override
  void initState() {
    super.initState();
