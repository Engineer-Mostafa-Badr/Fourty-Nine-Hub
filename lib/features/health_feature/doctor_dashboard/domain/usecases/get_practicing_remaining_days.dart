...
class GetDoctorPracticingRemainingDaysUseCase extends UseCase<int, String> {
  final DoctorDashboardRepo _repo;

  GetDoctorPracticingRemainingDaysUseCase(this._repo);

  @override
  Future<Either<Failure, int>> call(String params) {
    return _repo.getPracticingRemainingDays(params);
  }
}
