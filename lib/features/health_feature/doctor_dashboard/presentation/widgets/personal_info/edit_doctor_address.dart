      ...
      builder: (context,state) {
        return Column(
          children: [
            ...
            state.isLoadingCities?const Center(child: CircularProgressIndicator()):(state.isLoadingCitiesSuccess||state.selectedGovernorateId!=null)?SizedBox(
              width: double.infinity,
            ...
            DefaultTextFormField(
              ...
              currentController: context.read<EditDoctorPersonalInfoCubit>().addressController,
            ),
          ],
        );
      }
