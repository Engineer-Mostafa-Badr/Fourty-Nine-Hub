...
enum EditDoctorPersonalInfoStates { loading,loadCities,loadCitiesSuccess, error,success, initState,addCart }
...
extension EditDoctorPersonalInfoStateX on EditDoctorPersonalInfoState {
  ...
  bool get isLoadingCitiesSuccess => status == EditDoctorPersonalInfoStates.loadCitiesSuccess;
