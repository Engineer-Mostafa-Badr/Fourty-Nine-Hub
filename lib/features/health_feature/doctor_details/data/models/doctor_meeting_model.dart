...
class DoctorMeetingModel extends DoctorMeetingEntity{
  DoctorMeetingModel({required super.id, required super.roomId, required super.userId, required super.isFinish, required super.startDate, required super.endDate, required super.title,  super.members, required super.createdAt, required super.updatedAt});
