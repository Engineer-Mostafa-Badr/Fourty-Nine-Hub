...
class RequestHistoryRemoteDataSourceImpl
  ...
  //   final response =
  //       await _apiConsumer.get("https://3586-41-239-172-48.ngrok-free.app/api/v1/ride/trips/use");
  ...
  Future<Either<Failure, List<ShippingRequestModel>>>
    ...
    final response = await _apiConsumer
        .get("https://3586-41-239-172-48.ngrok-free.app/api/v1/loading/trip/allUserTrips");
    print("response ==$response\n");
    return response.fold(
        (failure) => Left(failure),
