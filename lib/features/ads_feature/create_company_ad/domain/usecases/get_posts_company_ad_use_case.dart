...
class GetPostsCompanyAdUseCase extends UseCase<List<CompanyAdEntity>,FetchPostCompanyAdvertiseParams>{
  final CompanyAdvertiseRepository _advertiseRepository;

  GetPostsCompanyAdUseCase(this._advertiseRepository);
  @override
  Future<Either<Failure, List<CompanyAdEntity>>> call(FetchPostCompanyAdvertiseParams params)async {
