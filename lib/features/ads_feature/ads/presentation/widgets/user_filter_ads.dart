...
class UserFilterAds extends StatefulWidget {
  const UserFilterAds({super.key, required this.userType, required this.params, required this.model});
            ...
            builderDelegate: PagedChildBuilderDelegate<AdModel>(
                ...
                firstPageProgressIndicatorBuilder: (context) =>
                    Container(
                        ...
                        child: const CupertinoActivityIndicator(color: AppColors.PRIMARY_COLOR)),
                newPageProgressIndicatorBuilder: (context) =>
                const CupertinoActivityIndicator(color: AppColors.PRIMARY_COLOR,)),
          );
        }
    );
  }
