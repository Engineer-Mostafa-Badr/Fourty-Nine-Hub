...
class MarriageSubCategoriesView extends StatefulWidget {
  ...
  const MarriageSubCategoriesView(
      {super.key, required this.mainCategory, this.inGridView = false,});
...
class _MarriageSubCategoriesViewState extends State<MarriageSubCategoriesView> {
  ...
  Future<void> _applyFilter(BuildContext context,
      SubcategoriesCubit controller) async {
           ...
           return Container(
            ...
            return Scaffold(
              floatingActionButton: CustomFloatingActionButton(
                ...
                text:
                "${LocaleKeys.add.localize} ${LocaleKeys.ad.localize} ${context
                    .isArabic ? "${context
                    .read<SubcategoriesCubit>()
                    .state
                    ...
                    .state
                    .subCategories
                    ?.indexWhere((element) => element.isSelected == true) ?? 0]
                    .nameAr}" : "${context
                    .read<SubcategoriesCubit>()
                    .state
                    .subCategories?[context
                                  ...
                                  onTap: () async {
                                    dynamic data = await context.push(
                                        ...
                                        extra: CategorizationEntity(
                                          ...
                                          state.subCategories?.indexWhere(
                                                  (element) =>
                                              element.isSelected ==
                                                  true) ??
                                              0],
                              ...
                              child: Container(
                                ...
                                child: Label(
                                  text: context.isArabic
                                      ...
                                      ''),
                                  color:
                                  state.subCategories?[index].isSelected == true
                                      ? Colors.white
                                      : null,
                                ),
                              ),
                              ...
                              ClickableWidget(
                                onTap: () {
                                  context.push(Routes.ADdetails,
                                      extra:
                                      controller.marriageAds[index].id);
                                },
                                child: Container(
