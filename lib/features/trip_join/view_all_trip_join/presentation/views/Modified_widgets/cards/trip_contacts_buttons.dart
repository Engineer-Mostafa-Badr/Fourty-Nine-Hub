...
class _ContactsTripButtonsState extends State<ContactsTripButtons> {
  ...
  Widget build(BuildContext context) {
    bool isEnabled =
        (widget.isButtonEnabled == true) || (widget.isPremium == true);
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        IconButton(
          visualDensity: const VisualDensity(horizontal: -4, vertical: -4),
          color: (isEnabled && context.read<UserCubit>().isLoggedIn)
                  ...
                  ? () {
                      ...
                      SubscriptionMethod().subscribe(
                        ...
                        onSubscribe: widget.onSubscribe == null
                            ? null
                            : (success) => widget.onSubscribe!(success),
                      );
                    }
                  : () {
                      ManageVibration.vibrate();
        ...
        IconButton(
          visualDensity: const VisualDensity(horizontal: -4, vertical: -4),
          color: (isEnabled == true && context.read<UserCubit>().isLoggedIn)
              ? AppColors.PRIMARY_COLOR
              : AppColors.DARK_GRAY_COLOR,
