...
class _NavigatorSubCategoriesViewState
  ...
  @override
  void initState() {
    // context.read<CustomPageCubit>().fetchFavouriteSubCat(widget.mainCategory.id);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      ...
      //   ..fetchFavouriteSubCat(widget.mainCategory.id),
      value: serviceLocator<CustomPageCubit>()
        ..fetchFavouriteSubCat(widget.mainCategory.id),
