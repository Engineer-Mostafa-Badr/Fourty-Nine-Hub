...
class WalletDataSource {
  ...
  Future<Either<Failure, WalletModel>> getWallet() async {
    ...
    //   "https://e2088eefa04f.ngrok-free.app/api/v1/main-wallet/66b4659d1c9c4b1cb35bfee4",
    //   options: Options(
    //     headers: {
    //       "Authorization":
    ...
    final result = await _apiConsumer
        .get("https://e2088eefa04f.ngrok-free.app/api/v1/main-wallet/66b4659d1c9c4b1cb35bfee4");
