...
class UserCubit extends Cubit<BasicState<UserEntity>> {
  ...
  bool get isLoggedIn => cacheService.getUserIsLoggedIn() ?? false;
  ...
  void logout() async {
    ...
    await cacheService.saveUserIsLoggedIn(false);
  ...
  Future<void> setUserLogged() async {
    log(isLoggedIn.toString(), name: "isLoggedIn");
    await cacheService.saveUserIsLoggedIn(true);
    log(isLoggedIn.toString(), name: "isLoggedIn");
  }
}
