            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    context.isArabic
                        ? "أظهر رخصة السائق أمامك والتقط صورة \n:كمثال"
                        : "Show your driver's license in front of you and take a photo\n:For example",
                  ...
                  Text(
                    context.isArabic
                        ? "يجب أن ثظهر الصورة بوضوح الوجه ورخصة\nالسائق"
                        : "The photo must clearly show the face and driver's license.",
                    style: Styles.headerText(fontWeight: FontWeight.w500),
                    textAlign: TextAlign.end,
                  ),
                  const Sizer(),
                  Text(
                    context.isArabic
                        ? "يجب التقاط الصورة في إضاءة جيدة وجودة\nجيدة"
                        : "The photo must be taken in good lighting and good quality.",
                    style: Styles.headerText(fontWeight: FontWeight.w500),
                    textAlign: TextAlign.end,
                  ),
                  const Sizer(),
                  Text(
                    context.isArabic
                        ? "غير مسموح بالتقاط صور باستخدام نظارة\nشمسية"
                        : "No photos with sunglasses allowed",
                    style: Styles.headerText(fontWeight: FontWeight.w500),
                    textAlign: TextAlign.end,
                  ),
                  const Sizer(),
