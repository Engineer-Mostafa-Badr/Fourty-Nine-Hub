...
class CriminalRecordRegisterCardWidget extends StatefulWidget {
  const CriminalRecordRegisterCardWidget({super.key});

  @override
  State<CriminalRecordRegisterCardWidget> createState() =>
      _CriminalRecordRegisterCardWidgetState();
}

class _CriminalRecordRegisterCardWidgetState
    extends State<CriminalRecordRegisterCardWidget> {
  File? image;
  @override
          ...
          children: [
            Container(
              ...
              child: Column(
                children: [
                  Text(
                    context.isArabic ? "سجل جنائي" : "Criminal Record",
