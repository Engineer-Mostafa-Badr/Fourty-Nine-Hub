  ...
  Widget build(BuildContext context) {
    return FormField(
      validator: (value) {
        if (expirationDate == null) {
          return context.isArabic?"يرجى إدخال تاريخ انتهاء الصلاحية":"Please enter the expiration date";
        }
        return null;
      },
      builder: (field) {
      ...
      child: Column(
        ...
        children: [
          Align(
            child: Text(
              context.isArabic?"تاريخ انتهاء الصلاحية":"Expiration date",
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                border: field.hasError? Border.all(color: AppColors.SECONDARY_COLOR_DARK):null,
                  color: context.isDarkMode?Colors.black12: Colors.grey.shade400,
                  borderRadius: BorderRadius.circular(10)),
              child: Row(
                children: [
    ...
    ValidationErrorWidget(message: field.errorText??"",),
          ...
          Align(
            ...
            child: Text(
              context.isArabic?"يرجى إدخال تاريخ انتهاء الصلاحية\nلمستنداتك":"Please enter the expiration date for your documents.",
              style:
