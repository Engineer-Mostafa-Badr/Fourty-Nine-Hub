...
import 'package:fourtyninehub/features/ride/RideRequest/presentation/widgets/offer_ride_card_widget.dart';
...
class _MyTripInfoRideWidgetState extends State<MyTripInfoRideWidget> {
  ...
  MyTripOfferRideModel? acceptedOffer;
  @override
  Widget build(BuildContext context) {
    return BlocListener<DeleteOfferRideCubit, RiderState>(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Flexible(
                                  child: Text(
                                    state.model.passengers.toString(),
    ...
    return BlocListener<RatingDriverCubit, RiderState>(
      listener: (context, state) {
        if (state is SuccessRateDvierState) {
          context.pop();
          context.read<CompleteNoSocketCubit>().complete(id: widget.tripId);
        }
      },
      child: Container(
        width: double.infinity,
