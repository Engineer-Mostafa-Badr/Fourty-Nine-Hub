...
class TechnicalExaminationRegisterCardWidget extends StatefulWidget {
  const TechnicalExaminationRegisterCardWidget({super.key});

  @override
  State<TechnicalExaminationRegisterCardWidget> createState() =>
      _TechnicalExaminationRegisterCardWidgetState();
}

class _TechnicalExaminationRegisterCardWidgetState
    extends State<TechnicalExaminationRegisterCardWidget> {
  File? image;
  @override
