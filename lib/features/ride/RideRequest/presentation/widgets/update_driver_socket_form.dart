...
class UpdateDriverSocketForm extends StatefulWidget {
  ...
  @override
  State<UpdateDriverSocketForm> createState() => _UpdateDriverSocketFormState();
}

class _UpdateDriverSocketFormState extends State<UpdateDriverSocketForm> {
          ...
          child: Column(
            ...
            children: [
              ...
              DriverLicenseCardRegisterRideWidget(
                initValue: widget.model.riderInfoId?.driverLicenseNumber,
              ...
              FrontDriverLicenseCardRegisterWidget(
                initImage: widget.model.riderInfoId?.drivingLicenseFrontKey
              ),
              const Sizer(
                height: 30,
              ),
              BehindDriverLicenseCardRegisterWidget(
                initImage: widget.model.riderInfoId?.drivingLicenseBehindKey,
                title: context.isArabic
              ...
              ExpirationDateDriverLicenseCardRegisterWidget(
                initValue: widget.model.riderInfoId?.drivingLicenseExpiryDate,
                onTap: (date) {
              ...
              //
              BehindDriverLicenseCardRegisterWidget(
                initImage: widget.model.riderInfoId?.idFrontKey,
                onTap: (image) {
              ...
              BehindDriverLicenseCardRegisterWidget(
                initImage: widget.model.riderInfoId?.idBehindKey,
                  onTap: (image) {
              ...
              DriverLicenseCardRegisterRideWidget(
                initValue: widget.model.riderInfoId?.idNumber,
              ...
              ExpirationDateDriverLicenseCardRegisterWidget(
                initValue: widget.model.riderInfoId?.idExpiryDate,
                onTap: (date) {
              ...
              IdentityConfirmationCardRegisterWidget(
                initImage: widget.model.riderInfoId?.confirmIdentityKey,
              ),
                            ...
                            Column(
                              children: [
                                ...
                                const DragAnalysisRegisterCardWidget(
                                  // initImage: widget.model.riderInfoId,
                                ),
                                const Sizer(
                                  height: 30,
                                ),
