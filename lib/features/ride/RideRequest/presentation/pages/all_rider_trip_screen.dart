...
class _AllRiderTripScreenState extends State<AllRiderTripScreen> {
  ...
  final LatLng _initialLocation = LatLng(30.0444, 31.2357);
  // Cairo coordinates
  ...
  void _addMarkers() {
    mapController.addSymbol(
      SymbolOptions(
        geometry: LatLng(30.0444, 31.2357), // إحداثيات القاهرة
    ...
    mapController.addSymbol(
      SymbolOptions(
        geometry: LatLng(30.0456, 30.2368), // موقع آخر في القاهرة
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Mapbox مع نقاط'),
      ),
      body: MapboxMap(
        // تأكد من استخدام MapboxMap كـ widget
