...
class ChangeDriverStatusCubit extends Cubit<RiderState> {
  ...
  Future<void> getDriverStatus() async {
    ...
    var response = await apiConsumer
        .get("https://2e43-2a09-bac1-2220-10-00-3b7-1a.ngrok-free.app/api/v1/ride/riders/check-activate");
  ...
  Future<void> changeDriverStatus() async {
    emit(LoadingGetDriverStatus());
    var response =
        await apiConsumer.put("https://2e43-2a09-bac1-2220-10-00-3b7-1a.ngrok-free.app/api/v1/ride/riders/activate");
