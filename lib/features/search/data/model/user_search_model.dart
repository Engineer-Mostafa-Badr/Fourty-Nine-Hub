...
class UserSearchModel extends UserSearchEntity {
  ...
  factory UserSearchModel.fromJson(Map<String, dynamic> json) {
    ...
    final profilePictureKey = userProfile != null ? userProfile['profilePictureKey'] : null;
    final mediaKey = profilePictureKey != null ? profilePictureKey['mediaKey'] : null;
    ...
    return UserSearchModel(
      ...
      phone: json['phone'] ?? '',
      image: mediaKey is String ? mediaKey : defaultImage,
    );
  }
}
