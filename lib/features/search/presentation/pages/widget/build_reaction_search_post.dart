...
class BuildReactionSearchPost extends StatefulWidget {
  const BuildReactionSearchPost(
      {super.key, required this.post, required this.from});
  final dynamic post;
  final String from;

  @override
  State<BuildReactionSearchPost> createState() => _BuildReactionsButtonsState();
}

class _BuildReactionsButtonsState extends State<BuildReactionSearchPost>
