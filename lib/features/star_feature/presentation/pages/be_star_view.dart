...
class _BeStarViewState extends State<BeStarView> {
        ...
        child: RefreshIndicator(
          ...
          child: ListView(
            ...
            children: [
              ...
              Text(
                context.isArabic
                    ? convertToArabicNumbers(state.banner?.titleAr ?? '')
  ...
  Widget buildHeaderInfo(StarEntity star) =>
      Row(
        children: [
          InkWell(
            onTap: () {
                    ...
                    child: Column(
                      ...
                      children: [
                        TextAppButton(
                          ...
                          onPressed: () {
                            context.push(
                                Routes.OTHERSACCOUNT, extra: star.user.id);
                          },
                        ),
                        RichText(
  ...
  Widget allImage(Function function, int length, String image) =>
      Container(
            ...
            child: Container(
              ...
              child: Align(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color: context.isDarkMode ? AppColors.PRIMARY_COLOR : Colors
                        .white,
                    fontWeight: FontWeight.bold,
                    fontSize: 28.sp,
                  ),
