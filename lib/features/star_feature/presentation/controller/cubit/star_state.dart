...
// Define data categories for better organization
enum TalentCategory { 
...
class StarState {
  ...
  List<StarEntity> get availableTalents => talents[TalentCategory.available] ?? [];
  List<StarEntity> get favoriteTalents => talents[TalentCategory.favorites] ?? [];
