...
class FetchWinnerStarUseCase extends UseCase<List<StarWinnerEntity>,StarPaginationParams>{
  final StarRepository _starRepository;

  FetchWinnerStarUseCase(this._starRepository);
  @override
  Future<Either<Failure, List<StarWinnerEntity>>> call(StarPaginationParams params)async {
