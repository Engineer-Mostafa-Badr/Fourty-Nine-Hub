              ...
              child: Column(
                ...
                children: [
                  Padding(
                      ...
                      children: [
                        Expanded(
                          child: Column(
                              ...
                              children: [
                                Label(
                                    text:  LocaleKeys.captainWithYou.tr(), //"Bus ride with You",
                                ...
                                Label(
                                    text: "${state.routeDetails?.pricePerSeat??0} ${LocaleKeys.egp.tr()}",
                                    style: const TextStyle(
                    ...
                    Label(
                        text: "${LocaleKeys.passenger.tr()} : ${state.routeDetails?.clients?.length??0}",
                        style: const TextStyle(
