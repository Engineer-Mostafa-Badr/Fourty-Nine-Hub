                                ...
                                Flexible(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(height: 4),
                                      Label(
                                        text: DateFormat('d-M-yyyy', context.isArabic ? 'ar' : 'en').format(
                                          (winner.updatedAt != null)
                                              ? DateTime.tryParse(winner.updatedAt!) ?? DateTime.now()
                                              : DateTime.now(),
                                        ),
                                        style: Styles.mediumText(
                                          fontWeight: FontWeight.w600,
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(height: 4),
                                          Text(
                                            DateFormat('d-M-yyyy', context.isArabic ? 'ar' : 'en')
                                                .format(
                                              (winner.updatedAt != null)
                                                  ? DateTime.tryParse(winner.updatedAt!) ?? DateTime.now()
                                                  : DateTime.now(),
                                          ...
                                          const SizedBox(height: 4),
                                          Text(
                                            "${NumberFormat.decimalPattern().format(winner.price ?? 0)} EGP",
                                            style: Styles.mediumText(
                                              fontWeight: FontWeight.w600,
                                              color: Colors.white,
                                            ),
            ...
            child: Material(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(16),
                  border:  Border(
                    left: BorderSide(color: Colors.white.withOpacity(0.7), width: 1.5),  // ← bold left border
                    right: BorderSide(color:Colors.white.withOpacity(0.7), width: 1.5), // ← bold right border
                  ),
                  boxShadow: [
                    BoxShadow(
                  ...
                  children: [
                    ...
                    Center(
                      child: Padding(
                        ...
                        child: Row(
                          mainAxisSize: MainAxisSize.min, // Row hugs its content
                          mainAxisAlignment: MainAxisAlignment.center,
                          ...
                          children: [
                            ...
                            const SizedBox(width: 14),
                            Column(
                              mainAxisSize: MainAxisSize.min, // Column hugs its content
