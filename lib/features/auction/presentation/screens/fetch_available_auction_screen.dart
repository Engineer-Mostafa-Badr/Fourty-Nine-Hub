...
// listen to tab changes
    _tabController.addListener(() {
      if (_tabController.index >= 0) { // always valid index
        final cubit = context.read<AuctionCubit>();
        ...
        switch (_tabController.index) {
          case 0:
            ...
            break;
          case 1:
          // cubit.getExpiredAuctions(); // implement in cubit
            break;
          case 2:
          // cubit.getFavoriteAuctions(); // implement in cubit
            break;
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              SvgPicture.asset(Assets.searchIcon,color: context.isDarkMode ? Colors.white : Colors.black,),
              Expanded(
                child: Container(
                  color:context.isDarkMode ? Colors.black  :Colors.white,
                  padding:
                    ...
                    onTap: (index) {
                      ...
                      switch (index) {
                        case 0:
                          ...
                          break;
                        case 1:
                          // cubit.getExpiredAuctions();
                          break;
                        case 2:
                          // cubit.getFavoriteAuctions();
                          break;
                        case 3:
                          // cubit.getRequestLogs();
                          break;
