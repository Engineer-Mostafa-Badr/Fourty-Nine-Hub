...
class GetMyAuctionUseCase extends UseCase<List<GetAvailableAuctionEntity >, GetAuctionParams> {
  final AuctionRepository _repo;

  GetMyAuctionUseCase(this._repo);

  @override
  Future<Either<Failure, List<GetAvailableAuctionEntity >>> call(GetAuctionParams params) async {
    return await _repo.getMyAuction(params:params);
  }
}
