...
class GetExpiredAuctionUseCase extends UseCase<List<GetAvailableAuctionEntity >, GetAuctionParams> {
  final AuctionRepository _repo;

  GetExpiredAuctionUseCase(this._repo);

  @override
  Future<Either<Failure, List<GetAvailableAuctionEntity >>> call(GetAuctionParams params) async {
    return await _repo.getExpiredAuction(params:params);
  }
}
