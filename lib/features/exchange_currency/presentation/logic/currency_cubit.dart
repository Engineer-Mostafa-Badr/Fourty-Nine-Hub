...
class CurrencyCubit extends Cubit<CurrencyState> {
  ...
  final List<CurrencyEntity> availableCurrencies = [
    CurrencyEntity(code: 'USD', name: 'US Dollar', nameAr: 'الدولار الأمريكي', flag: '🇺🇸'),
    CurrencyEntity(code: 'EUR', name: 'Euro', nameAr: 'اليورو', flag: '🇪🇺'),
    CurrencyEntity(code: 'GBP', name: 'British Pound', nameAr: 'الجنيه الإسترليني', flag: '🇬🇧'),
    CurrencyEntity(code: 'JPY', name: 'Japanese Yen', nameAr: 'الين الياباني', flag: '🇯🇵'),
    CurrencyEntity(code: 'AUD', name: 'Australian Dollar', nameAr: 'الدولار الأسترالي', flag: '🇦🇺'),
    CurrencyEntity(code: 'CAD', name: 'Canadian Dollar', nameAr: 'الدولار الكندي', flag: '🇨🇦'),
    CurrencyEntity(code: 'CHF', name: 'Swiss Franc', nameAr: 'الفرنك السويسري', flag: '🇨🇭'),
    CurrencyEntity(code: 'CNY', name: 'Chinese Yuan', nameAr: 'اليوان الصيني', flag: '🇨🇳'),
    CurrencyEntity(code: 'SEK', name: 'Swedish Krona', nameAr: 'الكرونا السويدية', flag: '🇸🇪'),
    CurrencyEntity(code: 'NZD', name: 'New Zealand Dollar', nameAr: 'الدولار النيوزيلندي', flag: '🇳🇿'),
    ...
    CurrencyEntity(code: 'EGP', name: 'Egyptian Pound', nameAr: 'الجنيه المصري', flag: '🇪🇬'),
    CurrencyEntity(code: 'AED', name: 'UAE Dirham', nameAr: 'الدرهم الإماراتي', flag: '🇦🇪'),
    CurrencyEntity(code: 'SAR', name: 'Saudi Riyal', nameAr: 'الريال السعودي', flag: '🇸🇦'),
    CurrencyEntity(code: 'QAR', name: 'Qatari Riyal', nameAr: 'الريال القطري', flag: '🇶🇦'),
    CurrencyEntity(code: 'KWD', name: 'Kuwaiti Dinar', nameAr: 'الدينار الكويتي', flag: '🇰🇼'),
    CurrencyEntity(code: 'BHD', name: 'Bahraini Dinar', nameAr: 'الدينار البحريني', flag: '🇧🇭'),
    CurrencyEntity(code: 'OMR', name: 'Omani Rial', nameAr: 'الريال العماني', flag: '🇴🇲'),
    CurrencyEntity(code: 'JOD', name: 'Jordanian Dinar', nameAr: 'الدينار الأردني', flag: '🇯🇴'),
