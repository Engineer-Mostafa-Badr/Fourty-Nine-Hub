...
class SubcategoriesCubit extends Cubit<SubcategoriesState> {
  ...
  SubcategoriesCubit(this._getSubcategoriesUsecase, this._toggleSubCategoryToFavoritesUseCase)
  ...
  Future<List<SubCategoryEntity>> getSubcategories(
    ...
    final response = await _getSubcategoriesUsecase(GetSubCategoriesParams(
        mainCategoryId: _mainCategoryId, paginationParams: paginationParams, userId: user??''));
    response.fold(
