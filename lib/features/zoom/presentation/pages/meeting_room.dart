...
class MeetingRoom extends StatefulWidget {
  const MeetingRoom({super.key, required this.liveID, required this.isHost, this.shareScreen = false});
...
class _MeetingRoomState extends State<MeetingRoom> {
  ...
  Widget build(BuildContext context) {
    ...
    zegoUIKitPrebuiltLiveStreamingHostConfig() => (ZegoUIKitPrebuiltLiveStreamingConfig.host()
    ...
    zegoUIKitPrebuiltLiveStreamingConfig() => ZegoUIKitPrebuiltLiveStreamingConfig.audience()
      ..bottomMenuBar.showInRoomMessageButton = false
      ..layout =
        ...
        child: BlocBuilder<MeetingCubit, MeetingState>(
          builder: (context, state) {
            ...
            return ZegoUIKitPrebuiltLiveStreaming(
              ...
              config:
                  widget.isHost ? zegoUIKitPrebuiltLiveStreamingHostConfig() : zegoUIKitPrebuiltLiveStreamingConfig(),
            );
          },
        ),
      ),
