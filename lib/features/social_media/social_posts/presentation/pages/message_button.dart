...
class MessageButton extends StatelessWidget {
  ...
  const MessageButton({super.key, required this.  user, required this.anonymousPress, required this.normalPress});
  ...
  void _startChat(BuildContext context, String label, UserProfileEntity cardUser) {
