...
import '../../../reels/domain/use_case/get_explore_reels_use_case.dart';
import '../../../twitter/domain/entities/twitter_post_entity.dart';
import '../../../twitter/domain/usecases/get_feed_usecase.dart';
import '../../domain/entities/comment_entity.dart';
import '../../domain/entities/facebook_feed_entity.dart';
import '../../domain/entities/post_entity.dart';
import '../../domain/entities/react_entity.dart';
...
import '../../domain/usecases/delete_friend_use_case.dart';
import '../../domain/usecases/delete_post_usecase.dart';
import '../../domain/usecases/edit_comment_usecase.dart';
import '../../domain/usecases/face_advertisement_use_case.dart';
import '../../domain/usecases/face_tweet_use_case.dart';
import '../../domain/usecases/follow_user_usecase.dart';
import '../../domain/usecases/friend_request_usecase.dart';
import '../../domain/usecases/get_feed_usecase.dart';
import '../../domain/usecases/get_global_feed_usecase.dart';
import '../../domain/usecases/get_post_comment_replies_usecase.dart';
...
import '../../domain/usecases/remove_friend_request_usecase.dart';
import '../../domain/usecases/remove_suggest_user_usecase.dart';
...
import '../../domain/usecases/view_profile_usecase.dart';
...
// get feed posts
  ...
  Future<void> getUsersSearch({
    ...
    emit(state.copyWith(status: StateStatus.loading));
    final response = await _searchUsersUsecase.call(TwitterFeedParams(
        page: usersSearchPage, limit: pageSize, search: search));
  ...
  Future loadCommentRepliesData({
    ...
    await getCommentReplies(
        context: context, commentId: commentId, comment: comment);
