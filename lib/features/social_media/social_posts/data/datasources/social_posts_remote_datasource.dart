...
abstract class SocialPostsRemoteDataSource {
  ...
  Future<Either<Failure, List<PostEntity>>> getGlobalFeed({required TwitterFeedParams params});
  Future<Either<Failure, List<PostEntity>>> getTweet({required TwitterFeedParams params});
  Future<Either<Failure, List<UserFriendEntity>>> searchUsers({required TwitterFeedParams params});
  ...
  Future<Either<Failure, UserProfileEntity>> getUserProfile({required String userId});
  ...
  Future<Either<Failure, List<PostEntity>>> getUserPosts({required UserPostsParams params});
  ...
  Future<Either<Failure, CommentEntity>> commentOnPost({required PostCommentParams params});
  Future<Either<Failure, List<CommentEntity>>> getPostComments({required PostCommentsParams params});
...
class SocialPostsRemoteDataSourceImpl implements SocialPostsRemoteDataSource {
  ...
  Future<Either<Failure, List<PostEntity>>> getFeed({required TwitterFeedParams params}) async {
    final response =
        await _apiConsumer.get(EndPoints.getFeedPosts(params), data: {'subCategory': Constants.facebookSubCategory});

    return response.fold((l) {
      return Left(l);
    }, (data) {
      final list = (data['data']['posts'] as List).map((e) => PostModel.fromJson(e)).toList();
      return Right(list);
    });
  }

  @override
  Future<Either<Failure, List<PostEntity>>> getGlobalFeed({required TwitterFeedParams params}) async {
  ...
  Future<Either<Failure, List<PostEntity>>> getAdvertisement({required TwitterFeedParams params}) async {
    ...
    return response.fold((l) {
      ...
      final list = (data['data']['advertises'] as List).map((e) => PostModel.fromJson(e)).toList();
      return Right(list);
    });
  }
  ...
  @override
  Future<Either<Failure, List<PostEntity>>> getUserPosts({required UserPostsParams params}) async {
    final response = await _apiConsumer.get(
      EndPoints.userPosts(params),
    );
    return response.fold(
        (l) => Left(l), (data) => Right((data['data']['posts'] as List).map((e) => PostModel.fromJson(e)).toList()));
  }
  ...
  @override
  Future<Either<Failure, bool>> reactOnComment({required PostReactParams params}) async {
    final response = await _apiConsumer.post(EndPoints.reactOnComment(params.postId), data: params.toJson());
    return response.fold((l) => Left(l), (data) => Right(data['status']));
  }

  @override
  Future<Either<Failure, CommentEntity>> commentOnPost({required PostCommentParams params}) async {
  ...
  @override
  Future<Either<Failure, List<CommentEntity>>> getPostComments({required PostCommentsParams params}) async {
    final response = await _apiConsumer.get(EndPoints.getPostComments(params));
    return response.fold((l) => Left(l),
        (data) => Right((data['data']['comments'] as List).map((e) => CommentModel.fromJson(e)).toList()));
  }

  @override
  Future<Either<Failure, List<CommentEntity>>> getPostCommentReplies({required PostCommentsParams params}) async {
    final response = await _apiConsumer.get(EndPoints.getPostCommentReplies(params));
    return response.fold((l) => Left(l),
        (data) => Right((data['data']['replies'] as List).map((e) => CommentModel.fromJson(e)).toList()));
  }
  ...
  Future<Either<Failure, List<SuggestUserEntity>>> suggestedFriends({required SuggestedFriendsParams params}) async {
    ...
    return response.fold(
        (l) => Left(l), (data) => Right((data['data'] as List).map((e) => SuggestUserModel.fromJson(e)).toList()));
  }
  ...
  @override
  Future<Either<Failure, bool>> removeFriendRequest({required String userId}) async {
    final response = await _apiConsumer.delete(EndPoints.removeFriendRequest(userId));
    return response.fold((l) => Left(l), (data) => Right(data['status']));
  }
  ...
  @override
  Future<Either<Failure, bool>> sendGreetMessage({required SendGreetMessageParams params}) async {
    final response = await _apiConsumer.post(EndPoints.greetMessage(params.userId), data: {"message": params.message});
    return response.fold((l) => Left(l), (data) => Right(data['status']));
  }
  ...
  Future<Either<Failure, bool>> sharePost({required params}) async {
    final response = await _apiConsumer.post(EndPoints.shareFacebookPost(params));
    return response.fold((l) => Left(l), (data) => Right(data['status']));
  }
  ...
  Future<Either<Failure, List<PostEntity>>> getTweet({required TwitterFeedParams params}) async {
    final response =
        await _apiConsumer.get("${EndPoints.getTwitterFeedPosts}&page=${params.page}&limit=${params.limit}");
  ...
  @override
  Future<Either<Failure, UserProfileEntity>> getUserProfile({required String userId}) async {
    final response = await _apiConsumer.get(
      EndPoints.getUserProfile(userId),
    );
    return response.fold((l) => Left(l), (data) => Right(UserProfileModel.fromJson(data['data'])));
  }
  ...
  Future<Either<Failure, bool>> editComment({required PostCommentParams params}) async {
    final response = await _apiConsumer.put(EndPoints.editComment(params), data: {'content': params.content});
    return response.fold((l) => Left(l), (data) => Right(data['status']));
  }
  ...
  Future<Either<Failure, bool>> acceptRejectFriendRequest({required AcceptRejectFriendRequestParams params}) async {
    final response =
        await _apiConsumer.put(EndPoints.acceptRejectFriendRequest(params), data: {'status': params.status});
    return response.fold((l) => Left(l), (data) => Right(data['status']));
  }
  ...
  Future<Either<Failure, List<UserFriendEntity>>> searchUsers({required TwitterFeedParams params}) async {
    final response = await _apiConsumer.get(EndPoints.searchUsers(params));

    return response.fold((l) {
      return Left(l);
    }, (data) {
      final list = (data['data'] as List).map((e) => UserFriendModel.fromJson(e)).toList();
      return Right(list);
    });
  }
}
