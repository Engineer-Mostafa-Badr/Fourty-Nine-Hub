...
class SuggestedFriendsUseCase extends UseCase<List<SuggestUserEntity>, SuggestedFriendsParams> {
  final SocialPostsRepo _repo;
  SuggestedFriendsUseCase(this._repo);
  @override
  Future<Either<Failure, List<SuggestUserEntity>>> call(SuggestedFriendsParams params) async {
