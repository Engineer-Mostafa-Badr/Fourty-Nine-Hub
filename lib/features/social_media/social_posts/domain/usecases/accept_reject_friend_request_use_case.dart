...
class AcceptRejectFriendRequestUseCase extends UseCase<bool, AcceptRejectFriendRequestParams> {
  final SocialPostsRepo _repo;
  AcceptRejectFriendRequestUseCase(this._repo);
  @override
  Future<Either<Failure, bool>> call(AcceptRejectFriendRequestParams params) async {
