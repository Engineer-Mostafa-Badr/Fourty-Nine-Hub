        ...
        children: [
          Container(
            decoration: const BoxDecoration(
              color: Colors.grey,
              image: DecorationImage(image: NetworkImage("https://s3-alpha-sig.figma.com/img/0bc9/9b33/fd3c921dc7e2bc5b7088deb7a22440e1?Expires=1739145600&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=Q5w1W4UBIARlKqcTvrrCNdwqYNoheZyKYo8Iz4-9-LjCHNHCmzFfhpXqUIRYsiTogoqGrQixrfRABx~L7MpyRt9q-icdAGba3nmK6iRKab8pwSOmEZhbzoKK7CLqZJR1uifF0XVGbHitut9YpMQBeytWZdlPrZZMPaukRpJn6gAwe7EElrjrdt7cz9itzgbDLmEeDKQ9aGeGyVn-ZHd0xayy34hdYzdKpiNqiMVj6y9XjJ8A9oZlHMrhRjhj4GClBqDVg6IqGWRXtnqypiQ~9uefKq5CDv14AVULrf2qOgjFiVYNOfN~494obslsRuvsEDD-p4O8Peb3iaIKo4NYaw__"), fit: BoxFit.cover)
            ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    const InstagramUserInfoWithMentionPostWidget(isMenchan: false, isReel: true, thereMusic: true,),
                    const Spacer(),
                    GestureDetector(
                        onTap: () {
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: const Center(child: Icon(Icons.volume_off_rounded, size: 20, color: Colors.white,)),
              )
            ],
          )
              ],
