...
class InstagramCommentReplies extends StatefulWidget {
  ...
  const InstagramCommentReplies(
      {super.key, required this.replies, required this.onAddReply, required this.commentId, required this.postId,
      });

  @override
  State<InstagramCommentReplies> createState() => _InstagramCommentRepliesState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider<InstagramCubit>(
        ...
        child:
        BlocBuilder<InstagramCubit, InstagramState>(builder: (context, state) {
