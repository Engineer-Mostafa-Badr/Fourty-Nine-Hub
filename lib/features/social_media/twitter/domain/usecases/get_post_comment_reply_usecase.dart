...
class GetTwitterCommentRepliesUseCase extends UseCase<List<TwitterCommentReplyEntity>, PostCommentsParams> {
  final TwitterRepo _repo;
  GetTwitterCommentRepliesUseCase(this._repo);
  @override
  Future<Either<Failure, List<TwitterCommentReplyEntity>>> call(PostCommentsParams params) async {
