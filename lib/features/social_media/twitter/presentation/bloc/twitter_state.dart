...
class TwitterState {
  ...
  const TwitterState(
      {this.shareStatus= StateStatus.loading,this.reactStatus= StateStatus.loading, this.status = StateStatus.loading, this.failure, this.posts, this.myPosts,this.postComments,this.commentReplies,this.shareSuccess=false,this.postDetails,this.newCommentId,this.newReplyId,this.newComment,this.newReply,this.reported,this.personalPhoto, this.frontId, this.backId, this.reportSuccess});
