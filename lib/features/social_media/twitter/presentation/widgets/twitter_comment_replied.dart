...
class _TwitterCommentRepliesState extends State<TwitterCommentReplies> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<TwitterCubit>(
      ...
      child: BlocBuilder<TwitterCubit, TwitterState>(builder: (context, state) {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            title: Label(
                text:
                    '${controller.repliesPagingController.itemList?.length} Replies',
            ...
            children: [
              Expanded(
                child: PagedListView<int, TwitterCommentReplyEntity>(
                  ...
                  builderDelegate:
                      PagedChildBuilderDelegate<TwitterCommentReplyEntity>(
