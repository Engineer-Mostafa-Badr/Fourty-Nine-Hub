  ...
  Widget build(BuildContext context) {
    ...
    return CustomScaffold(
      ...
      appBar: PreferredSize(
        ...
        child: BackAppBar(iconColor: Colors.white,
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Label(text: 'Media',style: Styles.headerText(
            ...
            Expanded(
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final imageUrl = "https://s3-alpha-sig.figma.com/img/8284/4a11/8666b8fa4f0bdd90f24cae1716fdc2c9?Expires=1745798400&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=UbuOTZ7LXOty926HRpdVRluHSw2fD7PuYl0fs-Oew24n-r60QuHFCJtd9WldO8DUm4vxbeKdsW-xdtFDHTvFlYCSvLhk6V40XaaWwxg0yTAozwtExmd9-AdQT2Uhis~89dXx7wSUUjM1EJhmBtAA1Fn7RHqvXVZHnwbAbWJMV0w4zladBCGCNPowUy-fbiTjfrTSAFkkLI4ewWlNoFyUysjK9QlYkR04Dvs01Wu-MtF9CAsfNZ9vwYXt2BHdOdw7xJ8Ko~OC1vBhKEGPMcs0-50hZ6zjwhF6WttYTCmVvDL3vr1ao~LGfPxytyv9oyIQ1rYn-KYyDcIkz8xLyFn3hg__";
                  // hasImage
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: hasImage ? null : const Color(0xFF262626),
                          image:
                          hasImage
                              ?
                          DecorationImage(
...
border: Border.all(color: Colors.white),
                            ...
                            gradient:hasImage?null: const LinearGradient(begin: Alignment.topCenter,
                              colors: [AppColors.PRIMARY_COLOR, Color(0xFFFF3308)],
                            ),
                              color: hasImage?const Color(0xFF1F1F1F):null,
                          ),
