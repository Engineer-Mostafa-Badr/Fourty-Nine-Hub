...
// //     final url = 'https://e2088eefa04f.ngrok-free.app/api/v1/categories/main/$id';
// //     final response =
...
// //     final url =
// //         'https://e2088eefa04f.ngrok-free.app/api/v1/chat/start-chat/$receiverId?categoryId=$subCategoryId';
...
// //     final url =
// //         'https://e2088eefa04f.ngrok-free.app/api/v1/chat/start-anonymous-chat/$receiverId';
// //     final response = await _makePostRequest(url: url, body: '{}');
// //     if (response != null) {
// //       final data = json.decode(response.body);
...
// //     final uri = Uri.parse('https://e2088eefa04f.ngrok-free.app/api/v1/tinder/get-profile/$userId')
...
// //     const url = 'https://e2088eefa04f.ngrok-free.app/api/v1/favorite-sub-category';
// //     final response =
...
// //     final url = 'https://e2088eefa04f.ngrok-free.app/api/v1/favorite-sub-category/$categoryId';
// //     final response = await _makePostRequest(url: url, body: '{}');
...
// //     final url =
// //         'https://e2088eefa04f.ngrok-free.app/api/v1/users/last-seen/$userId?status=online';
// //     final response =
...
// //     const url =
// //         'https://e2088eefa04f.ngrok-free.app/api/v1/tinder/sendGifts?subCategory=66af974f8bf69f9469944746';
...
// //     final url = 'https://e2088eefa04f.ngrok-free.app/api/v1/dashboard-gifts?limit=10';
...
// //     final url =
// //         'https://e2088eefa04f.ngrok-free.app/api/v1/tinder/check-distance/$cardUserId?subCategory=66af974f8bf69f9469944746';
// //     final response =
...
// //     const url = 'https://e2088eefa04f.ngrok-free.app/api/v1/tinder/subCategories';
// //     final response =
...
// //   //   // final url = 'https://e2088eefa04f.ngrok-free.app/api/v1/tinder/?gender=$gender&subCategory=66af974f8bf69f9469944746';
// //   //   // final url =
// //   //   //     'https://e2088eefa04f.ngrok-free.app/api/v1/tinder/?gender=female&page=4&subCategory=66af974f8bf69f9469944746&limit=10';
// //   //   final url =
// //   //       'https://e2088eefa04f.ngrok-free.app/api/v1/tinder/?gender=$gender&&subCategory=66af974f8bf69f9469944746';
// //   //   final response =
...
// //   //   final url =
// //   //       'https://e2088eefa04f.ngrok-free.app/api/v1/tinder/?gender=$gender&page=$page&subCategory=66af974f8bf69f9469944746&limit=20';
// //   //
// //   //   final response =
// //   //   await _makeGetRequest(url: url, fromMethod: 'fetchUserData');
// //   //
...
// //     const url =
// //         'https://e2088eefa04f.ngrok-free.app/api/v1/tinder/uploadPictures?subCategory=66af974f8bf69f9469944746';
...
//     const url = 'https://e2088eefa04f.ngrok-free.app/api/v1/favorite-category';
//     final response =
//         await _makeGetRequest(url: url, fromMethod: 'fetchFavorites');
//     if (response != null) {
//       final data = json.decode(response.body);
...
//
//   Future<LastSeenModel?> fetchLastSeen(String userId) async {
//     final url = 'https://e2088eefa04f.ngrok-free.app/api/v1/users/last-seen/$userId';
//     final response =
//         await _makeGetRequest(url: url, fromMethod: 'fetchLastSeen');
//     if (response != null) {
//       final data = json.decode(response.body);
...
//
//   Future<List<GiftData>?> fetchGifts() async {
//     const url = 'https://e2088eefa04f.ngrok-free.app/api/v1/dashboard-gifts?limit=10';
//     final response = await _makeGetRequest(url: url, fromMethod: 'fetchGifts');
//     if (response != null) {
//       final data = json.decode(response.body);
//       final giftApi = GiftApi.fromJson(data);
