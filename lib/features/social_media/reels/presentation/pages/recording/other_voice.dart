...
class OtherVoiceVideoRecordingScreenState
  ...
  Future _loadAndPlayAudio() async {
    try {
      ...
      _showErrorDialog(LocaleKeys.error_dialog_audio_playback_fail.tr());
    }
  }
  ...
  void _stopRecording() async {
    ...
    try {
      ...
      _showErrorDialog(
          LocaleKeys.error_dialog_stop_recording_fail.tr(args: [e.toString()]));
    }
  }
  ...
  Future<bool?> _mergeVideoWithAudio() async {
    ...
    // Combine the horizontal flip with the existing filter command
    ...
    final commandArgs = [
      ...
      '-map', '0:v:0',
      '-map', '1:a:0',
      '-c:v', 'mpeg4', // Using `mpeg4` for faster encoding
