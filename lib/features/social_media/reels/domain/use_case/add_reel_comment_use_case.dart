...
class AddReelCommentUseCase extends UseCase<AddCommentResponse, AddReelCommentParams> {
  final ReelsRepository _repository;

  AddReelCommentUseCase(this._repository);

  @override
  Future<Either<Failure, AddCommentResponse>> call(AddReelCommentParams params) {
