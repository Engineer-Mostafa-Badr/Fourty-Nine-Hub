class EditProfileEntity{
  ...
  EditProfileEntity(this.bioPrivacy, this.phonePrivacy, this.jobPrivacy, this.countryPrivacy, this.cityPrivacy, {required this.firstName, required this.lastName, required this.bio, required this.phone, required this.job, required this.country, required this.city,this.isMale=true});
