...
class StoryRepository {
  ...
  Future<List<Follower>> getAllFollowers(String subCategory) async {
    ...
    final url = Uri.parse(
        'https://b3c2387e02e3.ngrok-free.app/api/v1/follow/followers?subCategory=$subCategory');
  ...
  Future<void> updatePrivacy(String privacyType, {List<String>? users}) async {
    ...
    final url = Uri.parse('https://b3c2387e02e3.ngrok-free.app/api/v1/stories/privacy');
    final headers = {
      'Authorization': 'Bearer $_token',
      'Content-Type': 'application/json',
    };
  ...
  Future<void> deleteStory(String storyId) async {
    ...
    final response = await http.delete(
      Uri.parse("https://b3c2387e02e3.ngrok-free.app/api/v1/stories/$storyId"),
      headers: {
        "Authorization": "Bearer $_token",
      },
    );
  ...
  Future<List<UserStories>> fetchStories(int page) async {
    ...
    final response = await http.get(
      Uri.parse("https://b3c2387e02e3.ngrok-free.app/api/v1/stories/explore?page=$page"),
      headers: {
        "Authorization": "Bearer $_token",
      },
    );
