...
class StoryCubit extends Cubit<StoryState> {
  ...
  //       'https://3586-41-239-172-48.ngrok-free.app/api/v1/stories/mutedStories?limit=$limit&page=$page');
  ...
  Future<void> uploadStoryVideoOrImageOrVoice(
    ...
    final response = await http.post(
      Uri.parse('https://3586-41-239-172-48.ngrok-free.app/api/v1/stories'),
      headers: {
  ...
  Future<void> confirmUpload(String storyMediaId,
    ...
    final response = await http.put(
      Uri.parse(
          'https://3586-41-239-172-48.ngrok-free.app/api/v1/stories/success-upload/$storyMediaId'),
      headers: {
        'Authorization': 'Bearer $token',
        'Content-Type': 'application/json',
      },
