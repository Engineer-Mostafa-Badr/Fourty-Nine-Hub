...
class StoryCubit extends Cubit<StoryState> {
  ...
  Future<void> confirmUpload(String storyMediaId,
    ...
    final response = await http.put(
      Uri.parse(
          'https://d0e2803e70a6.ngrok-free.app/api/v1/stories/success-upload/$storyMediaId'),
      headers: {
  ...
  //       'https://d0e2803e70a6.ngrok-free.app/api/v1/stories/mutedStories?limit=$limit&page=$page');
  ...
  Future<void> uploadStoryVideoOrImageOrVoice(
    ...
    final response = await http.post(
      Uri.parse('https://d0e2803e70a6.ngrok-free.app/api/v1/stories'),
      headers: {
        'Authorization': 'Bearer $token',
        'Content-Type': 'application/json',
      },
