...
class _LifeEventSubCategoriesState extends State<LifeEventSubCategories> {
  ...
  void initState() {
    context
        ...
        .getLifeEventSubCategories(widget.lifeEvent.id);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          context.isArabic
              ? widget.lifeEvent.titleAr
              : widget.lifeEvent.titleEn,
      ...
      body: BlocBuilder<CreatePostCubit, CreatePostState>(
        ...
        return Column(
          ...
          children: [
            ...
            Padding(
                ...
                child: Container(
                  ...
                  child: CachedSvgImage(
                    imageUrl: widget.lifeEvent.image,
            ...
            Expanded(
                child: cubit.isLoadingMoreLifeEventSubCat
                    ? const Center(
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          LifeEventEntity selected = LifeEventEntity(
                              ...
                              titleAr:
                                  cubit.lifeEventSubCategories[index].titleAr,
                              titleEn:
                                  cubit.lifeEventSubCategories[index].titleEn,
                              image: cubit.lifeEventSubCategories[index].image,
                              media: cubit.lifeEventSubCategories[index].media,
                              title: context.isArabic
                                  ? cubit.lifeEventSubCategories[index].titleAr
                                  : cubit.lifeEventSubCategories[index].titleEn,
                              liveEventMainCategoryId: cubit
                                  .lifeEventSubCategories[index]
                            ...
                            child: Container(
                              ...
                              child: Column(children: [
                                Text(
                                  context.isArabic
                                      ? cubit
                                          .lifeEventSubCategories[index].titleAr
                                      : cubit.lifeEventSubCategories[index]
                                          .titleEn,
