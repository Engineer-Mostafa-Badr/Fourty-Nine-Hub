...
class GetClubVoiceUseCase extends UseCase<List<ClubVoiceRoomEntity>, NoParams> {
  final ClubVoiceRepository clubVoiceRepository;

  GetClubVoiceUseCase(this.clubVoiceRepository);

  @override
  Future<Either<Failure, List<ClubVoiceRoomEntity>>> call(NoParams params) {
    return clubVoiceRepository.getRooms();
  }
}
