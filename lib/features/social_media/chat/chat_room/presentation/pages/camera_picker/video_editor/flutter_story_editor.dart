                          ...
                          if (mode == StoryEditingModes.paint)
                            PaintControlsView(
                              onDoneClickListener: () async {
                                ...
                                await generateThumbnail(path: uiViewEditableFiles![currentPageIndex].path).then((generatedThumbnail) {
                                  setState(() {
                              ...
                              MainControlsView(
                                ...
                                onSaveClickListener: () async {
                                  ...
                                  for (int i = 0; i < widget.selectedFiles!.length; i++) {
                                    //!(widget.selectedFiles![i].isVideo)
                                    if (widget.selectedFiles![i].isImage) {
