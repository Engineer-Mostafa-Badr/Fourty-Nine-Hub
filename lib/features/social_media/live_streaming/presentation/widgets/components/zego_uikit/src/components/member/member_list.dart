...
typedef ZegoMemberListItemBuilder = Widget Function(
  ...
  Size size,
  user.ZegoUIKitUser user,
  Map<String, dynamic> extraInfo,
);

/// sort
typedef ZegoMemberListSorter = List<user.ZegoUIKitUser> Function(
  user.ZegoUIKitUser localUser,
  List<user.ZegoUIKitUser> remoteUsers,
);
...
class ZegoMemberList extends StatefulWidget {
  ...
  final Stream<List<user.ZegoUIKitUser>>? stream;
  final List<user.ZegoUIKitUser> pseudoUsers;
...
class _ZegoCallMemberListState extends State<ZegoMemberList> {
  var usersNotifier = ValueNotifier<List<user.ZegoUIKitUser>>([]);
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<List<user.ZegoUIKitUser>>(
      valueListenable: usersNotifier,
      builder: (context, tempUsers, child) {
        final remoteUsers = List<user.ZegoUIKitUser>.from(tempUsers.reversed)
  ...
  void onUserListUpdated(List<user.ZegoUIKitUser> users) {
