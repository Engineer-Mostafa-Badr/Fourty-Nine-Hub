...
// Project imports:
import '../core/data/media.dart';
import '../core/data/message.dart';
import '../core/data/network_timestamp.dart';
import '../core/data/screen_sharing.dart';
import '../core/data/stream.dart';
...
class ZegoUIKitCore
  ...
  Future<String> getZegoUIKitVersion() async {
    ...
    const zegoUIKitVersion = 'zego_uikit: 2.24.3; ';
  ...
  Future<ZegoRoomLoginResult> joinRoom(
    ...
    ZegoLoggerService.logInfo(
      'room id:"$roomID", markAsLargeRoom:$markAsLargeRoom',
      tag: 'uikit-room',
      subTag: 'join room',
    );
