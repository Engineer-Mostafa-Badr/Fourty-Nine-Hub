...
import '../../services/defines/user.dart' as local_user;
...
class _ZegoAudioVideoViewState extends State<ZegoAudioVideoView> {
  ...
  Widget videoView() {
    ...
    return StreamBuilder<List<local_user.ZegoUIKitUser>>(
        ...
        return Stack(
          children: [
            ValueListenableBuilder(
              valueListenable: local_user.ZegoUIKitUserPropertiesNotifier(
                widget.user ?? local_user.ZegoUIKitUser.empty(),
              ),
