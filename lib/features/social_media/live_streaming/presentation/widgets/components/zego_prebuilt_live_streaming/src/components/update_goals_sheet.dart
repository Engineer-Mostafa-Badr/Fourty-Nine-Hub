...
Future<void> showUpdateGoalsSheet(BuildContext context,{bool? showEdit=false, required Function(String id) onEdit, Function? editGift}) async {
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                            ...
                                            child: ListView.builder(
                                              itemCount: context.read<StreamCubit>().state.selectedGifts.length,
                                              // gridDelegate:
                                              ...
                                              itemBuilder: (context, index) {
                                                ...
                                                return _buildItem(context,context.read<StreamCubit>().state.selectedGifts[index],onEdit: onEdit);
                                              },
                                            ),
                                          ),
                                        ],
              ...
              content: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: (){
                        print('state.liveCreateResponseEntity?.goals${context.read<StreamCubit>().state.liveCreateResponseEntity?.goals}');
                        print(context.read<StreamCubit>().state.liveCreateResponseEntity?.goals.length);
                        print(context.read<StreamCubit>().state.liveCreateResponseEntity?.goals.firstWhereOrNull((e)=>e.giftId==gift.sId)?.id);

                        if(context.read<StreamCubit>().formKey.currentState!.validate()){
                          print("context.read<StreamCubit>().${context.read<StreamCubit>().goalController.text}");
                          context.read<StreamCubit>().editGoal(gift.sId??'',context.read<StreamCubit>().goalController.text.trim());
