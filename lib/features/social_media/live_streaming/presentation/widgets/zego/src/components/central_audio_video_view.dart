...
import 'package:fourtyninehub/features/social_media/live_streaming/presentation/widgets/zego/src/pk/components/view.dart';
import 'package:fourtyninehub/features/social_media/live_streaming/presentation/widgets/zego/src/pk/core/core.dart';
import 'package:fourtyninehub/features/social_media/live_streaming/presentation/widgets/zego/src/pk/core/service/defines.dart';
...
class ZegoLiveStreamingCentralAudioVideoViewState
  ...
  Widget audioVideoView(ZegoUIKitUser? host,
      double preferWidth,
      double preferHeight,
  ...
  Widget audioVideoWidget(double preferWidth,
      double preferHeight,
      bool withScreenSharing,) {
  ...
  Widget defaultAudioVideoContainer(bool withScreenSharing) {
    return BlocBuilder<MeetingCubit,MeetingState>(
      builder: (context, state) {
        if(state is OpenWhiteBoardState){
          return Container();
        }else {
  ...
  void onLiveStatusUpdated() {
    ZegoLoggerService.logInfo(
      'live page, live status mgr updated, ${widget.liveStatusManager.notifier
          .value}',
      tag: 'live-streaming',
