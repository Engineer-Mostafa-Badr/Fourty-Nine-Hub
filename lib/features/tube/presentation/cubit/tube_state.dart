...
class TubeState {
  ...
  final StateStatus uploadStatus; // Added missing uploadStatus field
  ...
  TubeState({
    ...
    this.videos = const [], // Initialize videos as empty list
    this.uploadStatus = StateStatus.initial, // Initialize uploadStatus
  });
  ...
  TubeState copyWith({
    ...
    StateStatus? uploadStatus, // Added uploadStatus parameter
  }) {
    return TubeState(
      ...
      uploadStatus: uploadStatus ?? this.uploadStatus, // Added uploadStatus
      getMyTubeVideosData: getMyTubeVideosData ?? this.getMyTubeVideosData, // Added uploadStatus
    );
  }
}
// class TubeState {
