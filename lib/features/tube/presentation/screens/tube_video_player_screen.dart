...
class _VideoPlayerPageState extends State<VideoPlayerPage> {
  ...
  bool _isImageContent(GetAllTubeVideosEntity video) =>
      video.videoUrl == null || video.videoUrl!.isEmpty;
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // Views and date
                            Text(
                              '${_formatCount(currentVideo.views ?? 0)} views • ${currentVideo.updatedAt != null ? DateFormat('MMM d, yyyy', context.isArabic ? 'ar' : 'en').format(DateTime.parse(currentVideo.updatedAt!)) : ''}',
                              style: const TextStyle(
                                color: Color(0xFFAAAAAA),
                                fontSize: 13,
                              ),
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 2),
                                  Text(
                                    '${_formatCount(currentVideo.subscriberCount ?? 0)} subscribers',
                                    style: const TextStyle(
                                      color: Color(0xFFAAAAAA),
                                      fontSize: 12,
                                    ),
...
class _CommentItemState extends State<CommentItem> {
  ...
  bool get _isEdited => widget.comment.updatedAt
  ...
  Widget build(BuildContext context) {
    ...
    final repliesCount = widget.comment.replies.length;
    final width = MediaQuery.of(context).size.width;
    final isMyComment = widget.comment.isMyComment;
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                            ...
                            Row(
                              children: [
                                _ActionButton(
                                  ...
                                  isActive: widget.comment.isLike,
                                ),
                                const SizedBox(width: 12),
                                _ActionButton(
                                  icon: widget.comment.isDislike
                                      ? Icons.thumb_down
                                  ...
                                  isActive: widget.comment.isDislike,
                                ),
                                if (!widget.isReply)
                                  Row(
                                    children: [
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                onTap: () {
                                  context
                                      .read<TubeCubit>()
                                      .toggleCommentReplies(widget.comment.id);
                                },
                                child: Row(
                                  children: [
                                    Icon(
                    ...
                    else if (!isMyComment && !_isEditing)
                      IconButton(
                        icon: const Icon(Icons.more_vert,
  ...
  void _handleLike(BuildContext context) {
    final cubit = context.read<TubeCubit>();
    cubit.likeComment(widget.comment.id, widget.videoId);
  }

  void _handleDislike(BuildContext context) {
    final cubit = context.read<TubeCubit>();
    cubit.dislikeComment(widget.comment.id, widget.videoId);
  }
                            ...
                            ...latestComment.replies.map((reply) {
                              return CommentItem(
                                comment: TubeCommentEntity(
                                  ...
                                  likes: reply.likes,
                                  dislikes: reply.dislikes,
                                  allLike: [], // Set to empty list since not available in TubeReplyEntity
                                  allDislike: [], // Set to empty list since not available in TubeReplyEntity
                                  isLike: reply.isLike,
                                  isDislike: reply.isDislike,
                                  isMyComment: reply.isMyComment,
...
class _AddCommentWidgetState extends State<AddCommentWidget> {
  ...
  void _postComment() async {
    ...
    // Close reply dialog if applicable
