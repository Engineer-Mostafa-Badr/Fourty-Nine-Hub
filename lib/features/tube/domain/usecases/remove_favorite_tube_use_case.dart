...
class RemoveFavoriteTubeUseCase extends UseCase<AddFavoriteTubeEntity , FavoriteTubeParams> {
  final TubeRepository _repo;

  RemoveFavoriteTubeUseCase(this._repo);
  @override
  Future<Either<Failure, AddFavoriteTubeEntity >> call(FavoriteTubeParams params) async {
    return await _repo.removeFavoriteTube(params: params);
  }
