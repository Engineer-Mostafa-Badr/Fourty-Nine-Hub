...
class GetMyTubeVideosUseCase extends UseCase<List<GetAllTubeVideosEntity  >, GetAllTubeVideosParams> {
  final TubeRepository _repo;

  GetMyTubeVideosUseCase(this._repo);

  @override
  Future<Either<Failure, List<GetAllTubeVideosEntity>>> call(GetAllTubeVideosParams params) async {
    return await _repo.getMyTubeVideos(params:params);
  }
}
