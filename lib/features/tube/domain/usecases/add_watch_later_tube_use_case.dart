...
class AddWatchLaterTubeUseCase extends UseCase<AddFavoriteTubeEntity , FavoriteTubeParams> {
  final TubeRepository _repo;

  AddWatchLaterTubeUseCase(this._repo);
  @override
  Future<Either<Failure, AddFavoriteTubeEntity >> call(FavoriteTubeParams params) async {
    return await _repo.addWatchLaterTube(params: params);
  }
