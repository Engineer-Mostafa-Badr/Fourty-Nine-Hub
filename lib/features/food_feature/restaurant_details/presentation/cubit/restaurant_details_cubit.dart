...
class RestaurantDetailsCubit extends Cubit<RestaurantDetailsState> {
  ...
  Future<void> createNormalOrder(
    ...
    const url = 'https://d0531cde0723.ngrok-free.app/api/v1/food/make-order';
    ...
    response.fold(
      ...
      (data) async {
        ...
        log("${data['message']}    const url = 'https://d0531cde0723.ngrok-free.app/api/v1/food/make-order';");
  ...
  Future<void> createPremiumOrder(
    ...
    const url = 'https://d0531cde0723.ngrok-free.app/api/v1/food/make-order-premium';
  ...
  Future<void> fetchCart({bool? first = false}) async {
    ...
    const url = 'https://d0531cde0723.ngrok-free.app/api/v1/food/getCart';
