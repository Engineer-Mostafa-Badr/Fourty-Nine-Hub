...
class RestaurantDetailsCubit extends Cubit<RestaurantDetailsState> {
  ...
  Future<void> fetchCart({bool? first = false}) async {
    ...
    const url = 'https://6db25d211280.ngrok-free.app/api/v1/food/getCart';
  ...
  Future<void> createPremiumOrder(
    ...
    const url = 'https://6db25d211280.ngrok-free.app/api/v1/food/make-order-premium';
  ...
  Future<void> createNormalOrder(
    ...
    const url = 'https://6db25d211280.ngrok-free.app/api/v1/food/make-order';
    ...
    response.fold(
      ...
      (data) async {
        ...
        final orderData =
            data['data']; // Adjust based on your API response structure
        // final order = Order.fromJson(orderData);
        log("${data['message']}    const url = 'https://6db25d211280.ngrok-free.app/api/v1/food/make-order';");
        Navigator.pop(context);
