...
class RestaurantDetailsCubit extends Cubit<RestaurantDetailsState> {
  ...
  Future<void> createNormalOrder(
    ...
    const url = 'https://1d2f0756d123.ngrok-free.app/api/v1/food/make-order';
    ...
    response.fold(
      ...
      (data) async {
        ...
        log("${data['message']}    const url = 'https://1d2f0756d123.ngrok-free.app/api/v1/food/make-order';");
  ...
  Future<void> createPremiumOrder(
    ...
    const url = 'https://1d2f0756d123.ngrok-free.app/api/v1/food/make-order-premium';
  ...
  Future<void> fetchCart({bool? first = false}) async {
    ...
    const url = 'https://1d2f0756d123.ngrok-free.app/api/v1/food/getCart';
