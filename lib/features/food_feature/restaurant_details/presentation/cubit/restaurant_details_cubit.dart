...
class RestaurantDetailsCubit extends Cubit<RestaurantDetailsState> {
  ...
  Future<void> createNormalOrder(
    ...
    const url = 'https://c2d1142831e7.ngrok-free.app/api/v1/food/make-order';
    ...
    response.fold(
      ...
      (data) async {
        ...
        log("${data['message']}    const url = 'https://c2d1142831e7.ngrok-free.app/api/v1/food/make-order';");
  ...
  Future<void> createPremiumOrder(
    ...
    const url = 'https://c2d1142831e7.ngrok-free.app/api/v1/food/make-order-premium';
  ...
  Future<void> fetchCart({bool? first = false}) async {
    ...
    const url = 'https://c2d1142831e7.ngrok-free.app/api/v1/food/getCart';
