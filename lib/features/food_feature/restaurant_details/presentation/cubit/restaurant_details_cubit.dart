...
class RestaurantDetailsCubit extends Cubit<RestaurantDetailsState> {
  ...
  Future<void> fetchCart({bool? first = false}) async {
    ...
    const url = 'https://c433-41-239-172-48.ngrok-free.app/api/v1/food/getCart';
  ...
  Future<void> createPremiumOrder(
    ...
    const url = 'https://c433-41-239-172-48.ngrok-free.app/api/v1/food/make-order-premium';
  ...
  Future<void> createNormalOrder(
    ...
    const url = 'https://c433-41-239-172-48.ngrok-free.app/api/v1/food/make-order';
    ...
    response.fold(
      ...
      (data) async {
        ...
        final orderData =
            data['data']; // Adjust based on your API response structure
        // final order = Order.fromJson(orderData);
        log("${data['message']}    const url = 'https://c433-41-239-172-48.ngrok-free.app/api/v1/food/make-order';");
        Navigator.pop(context);
