...
//
// import '../restaurants_list_cubit.dart';
//
//
...
//
//     final String url =
//         'https://2e43-2a09-bac1-2220-10-00-3b7-1a.ngrok-free.app/api/v1/favorite-category/$categoryId'; // API endpoint for the category
//
//     // API request headers
...
//     log('aaaaaaaaaaaaaaaaaasssssssssssssddddddddddddddddddddddddddd${serviceLocator<UserCubit>().state.data?.id}');
//     response.fold(
//         (failure) => emit(state.copyWith(
//             failure: failure, status: RestaurantsListStates.error)),
//         (data) => emit(state.copyWith(
