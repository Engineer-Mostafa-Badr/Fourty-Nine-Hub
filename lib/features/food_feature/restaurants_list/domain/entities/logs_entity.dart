...
class LogsRequestLogsEntity {
  ...
  final UserRateRestaurantEntity? userRateRestaurant;
  final dynamic restaurantRateUser;
  final RatingNameEntity? userRateRestaurantName;
  final RatingNameEntity? restaurantRateUserName;
  ...
  LogsRequestLogsEntity copyWith({
    ...
    UserRateRestaurantEntity? userRateRestaurant,
    dynamic restaurantRateUser,
    RatingNameEntity? userRateRestaurantName,
    RatingNameEntity? restaurantRateUserName,
  }) {
    return LogsRequestLogsEntity(
      id: id ?? this.id,
      userId: userId ?? this.userId,
...
class SubscriptionTypeEntity {
  ...
  SubscriptionTypeEntity({this.ar, this.en});
}

class RatingNameEntity {
  final String? ar;
  final String? en;

  RatingNameEntity({this.ar, this.en});
}
