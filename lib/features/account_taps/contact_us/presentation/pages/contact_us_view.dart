...
class _ContactUsViewState extends State<ContactUsView> {
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Label(text: LocaleKeys.contactUs.localize ?? '',
  ...
  Widget buildContainerPhoneAndEmail(Size size,String title,String val,IconData icon,Function()?onTap){
    return   InkWell(
      onTap: (){
     onTap!();
      },
            ...
            Column(
              ...
              children: [
                ...
                Label(
                  text: title,
                  style: Styles.mediumText(fontSize: 50.sp,
                      color: AppColors.PRIMARY_COLOR,fontWeight: FontWeight.w500),
                ),
                const SizedBox(
                  height: 5,
                ),
