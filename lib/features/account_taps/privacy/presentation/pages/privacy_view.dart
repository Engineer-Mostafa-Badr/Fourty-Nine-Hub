              ...
              child: BlocBuilder<PrivacyCubit, PrivacyState>(
                builder: (BuildContext context, state) {
                  ...
                  if (state.personalPrivacyEntity == null) {
                    return Center(
                      child: Text(
                        context.isArabic ? "لا يوجد بيانات" : "No Data",
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            PrivacyMultiSelectItem(
                              ...
                              privacy:
                                  state.personalPrivacyEntity?.country ?? '',
                              name: mapPrivacyFeatureToString(
                                  PrivacyFeature.country),
                              onChoose: (PrivacyStatus value,
                                ...
                                if (value == PrivacyStatus.onlyWith) {
                                  context
                                      .read<PrivacyCubit>()
                                      .updateOnlyWithPrivacy(
                                        params: UpdateOnlyWithPrivacyParams(
                                          allowedUsers: selectedUsers ?? [],
                                          feature: mapPrivacyFeatureToString(
                                              feature),
                                        ),
                                      )
                                      .then((_) {
                                  ...
                                  if (mappedPrivacy == "except-from") {
                                    mappedPrivacy =
                                        "only-me"; // Change this to an appropriate default value
                                  }
                                  ...
                                  context
                                      ...
                                      .updateDataPersonalPrivacy(
                                        params: UpdatePersonalPrivacyParams(
                                          ...
                                          newPrivacyOption:
                                              mappedPrivacy, // The new privacy option
                                        ),
                                      )
                                      .then((_) {
                                    context.read<PrivacyCubit>().loadData();
                            ...
                            PrivacyMultiSelectItem(
                              name:
                                  mapPrivacyFeatureToString(PrivacyFeature.job),
                            ...
                            PrivacyMultiSelectItem(
                              ...
                              privacy: state.personalPrivacyEntity?.city ?? '',
                              onChoose: (PrivacyStatus value,
                                  List<String>? selectedUsers) {
                                PrivacyFeature feature =
                                    PrivacyFeature.language;
                            ...
                            PrivacyMultiSelectItem(
                              name: mapPrivacyFeatureToString(
                                  PrivacyFeature.lastSeen),
                              label: LocaleKeys.lastSeen.localize,
                              privacy:
                                  state.communicationPrivacyEntity?.lastSeen ??
                                      '',
                              onChoose: (PrivacyStatus value,
                                  List<String>? selectedUsers) {
                                PrivacyFeature feature =
                            ...
                            PrivacyMultiSelectItem(
                              name: mapPrivacyFeatureToString(
                                  PrivacyFeature.friendsList),
                              label: LocaleKeys.friendsList.localize,
                              privacy:
                                  state.connectionPrivacyEntity?.friendsList ??
                                      '',
                              onChoose: (PrivacyStatus value,
                                  List<String>? selectedUsers) {
                                PrivacyFeature feature =
                            ...
                            PrivacyMultiSelectItem(
                              name: mapPrivacyFeatureToString(
                                  PrivacyFeature.followerList),
                              label: LocaleKeys.followerList.localize,
                              privacy:
                                  state.connectionPrivacyEntity?.followerList ??
                                      '',
                              onChoose: (PrivacyStatus value,
                                  List<String>? selectedUsers) {
                                PrivacyFeature feature =
                            ...
                            PrivacyMultiSelectItem(
                              name: mapPrivacyFeatureToString(
                                  PrivacyFeature.receiveAnonymousMessages),
                            ...
                            PrivacyMultiSelectItem(
                              name: mapPrivacyFeatureToString(
                                  PrivacyFeature.receiveGreetMessages),
                            ...
                            PrivacyMultiSelectItem(
                              name: mapPrivacyFeatureToString(
                                  PrivacyFeature.receiveSocialMessages),
                            ...
                            PrivacyMultiSelectItem(
                              name: mapPrivacyFeatureToString(
                                  PrivacyFeature.randomAppearance),
                            ...
                            PrivacyMultiSelectItem(
                              name: mapPrivacyFeatureToString(
                                  PrivacyFeature.followerRequests),
                            ...
                            PrivacyMultiSelectItem(
                              name: mapPrivacyFeatureToString(
                                  PrivacyFeature.showPosts),
                              label: LocaleKeys.showPosts.localize,
                              privacy:
                                  state.mediaPrivacyEntity?.showPosts ?? '',
                              onChoose: (PrivacyStatus value,
                                  List<String>? selectedUsers) {
                                PrivacyFeature feature =
                                    PrivacyFeature.showPosts;
                            ...
                            PrivacyMultiSelectItem(
                              name: mapPrivacyFeatureToString(
                                  PrivacyFeature.showStories),
                              label: LocaleKeys.showStories.localize,
                              privacy:
                                  state.mediaPrivacyEntity?.showStories ?? '',
                              onChoose: (PrivacyStatus value,
                                  List<String>? selectedUsers) {
                                PrivacyFeature feature =
                                    PrivacyFeature.showStories;
                            ...
                            PrivacyMultiSelectItem(
                              name: mapPrivacyFeatureToString(
                                  PrivacyFeature.showReels),
                              label: LocaleKeys.showReels.localize,
                              privacy:
                                  state.mediaPrivacyEntity?.showReels ?? '',
                              onChoose: (PrivacyStatus value,
                                  List<String>? selectedUsers) {
                                PrivacyFeature feature =
                                    PrivacyFeature.showReels;
                            ...
                            PrivacyMultiSelectItem(
                              name: mapPrivacyFeatureToString(
                                  PrivacyFeature.writeComments),
                              label: LocaleKeys.writeComments.localize,
                              privacy:
                                  state.mediaPrivacyEntity?.writeComments ?? '',
                              onChoose: (PrivacyStatus value,
                                  List<String>? selectedUsers) {
                                PrivacyFeature feature =
                                    PrivacyFeature.writeComments;
