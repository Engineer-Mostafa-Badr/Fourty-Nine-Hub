...
class GetSubscriptionWalletUseCase extends UseCase<List<WalletSubscriptionEntity>,NoParams>{
  final WalletRepo _walletRepo;

  GetSubscriptionWalletUseCase(this._walletRepo);
  @override
  Future<Either<Failure, List<WalletSubscriptionEntity>>> call(NoParams params) async{
