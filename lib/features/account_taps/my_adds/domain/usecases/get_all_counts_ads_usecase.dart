...
class GetAllCountsAdsUseCase extends UseCase<List<GetAllCountAdsEntity>, CountAdsParams> {
  final MyAdsRepo _repo;
  GetAllCountsAdsUseCase(this._repo);

  @override
  Future<Either<Failure, List<GetAllCountAdsEntity>>> call(CountAdsParams params) {
