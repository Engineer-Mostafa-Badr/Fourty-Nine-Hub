...
class FetchWinnerCompetitionUseCase extends UseCase<List<WinnerCompetitionEntity>, NoParams> {
  final CompetitionRepository _competitionRepository;

  FetchWinnerCompetitionUseCase(this._competitionRepository);

  @override
  Future<Either<Failure, List<WinnerCompetitionEntity>>> call(NoParams params) async {
