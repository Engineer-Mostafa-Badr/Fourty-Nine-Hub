...
class GetClientAcceptedShippingTripsUseCase extends UseCase<List<ClientAcceptedTripEntity > , ClientPendingTripParams> {
  final RideRepository _repo;

  GetClientAcceptedShippingTripsUseCase(this._repo);

  @override
  Future<Either<Failure, List<ClientAcceptedTripEntity >>> call(ClientPendingTripParams params) async {
    return await _repo.getClientAcceptedShippingTrips(params: params);
  }
}
