...
class RideExpectedPriceEntity {
  ...
  RideExpectedPriceEntity(
      {required this.priceForWomen,
      required this.priceForTaxi,
      required this.priceForScooter,
      required this.priceForCaptain,
      required this.priceForPremium,
      required this.priceForIntercity,
      required this.priceForSUV,
      required this.lowestFare,
      required this.highestFare,
      required this.from,
      required this.to,
