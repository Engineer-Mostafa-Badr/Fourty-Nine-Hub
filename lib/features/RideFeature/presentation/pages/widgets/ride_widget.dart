                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Label(
                                      text: userTripEntity.rate.toString(),
                      ...
                      children: [
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Label(
                                      text: userTripEntity.startLocation,
                                ...
                                Row(
                                  children: [
                                    ...
                                    Label(
                                      text: userTripEntity.targetLocation,
                                      style: Styles.mediumText(),
                                    ),
                                  ],
                                ),
                        ...
                        isTruck
                            ? GestureDetector(
                                ...
                                child: Label(
                                  text:
                                      'Cargo Description : ${userTripEntity.desc}',
                        ...
                        Row(
                          ...
                          children: [
                            Label(
                              text: userTripEntity.price.toString(),
                              style: Styles.mediumText(
                            ...
                            Label(
                              text: context.isArabic
                                  ? userTripEntity.currency.currencyAr
                                  : userTripEntity.currency.currencyEn,
                              style: Styles.mediumText(
                                color: AppColors.SECONDARY_COLOR,
                                fontWeight: FontWeight.w700,
                              ),
                            ...
                            Label(
                              text: DateFormat('hh:mm a')
                                  .format(DateTime.parse(
                                      userTripEntity.time.substring(0, 19)))
                                  .toString(),
                              style: Styles.mediumText(
                                fontWeight: FontWeight.w700,
                              ),
                                      ...
                                      bottomSheet(
                                        ...
                                        widget: Column(
                                          ...
                                          children: [
                                            ...
                                            AppButton(
                                              label:
                                                  '${LocaleKeys.free.localize} ${LocaleKeys.call.localize}',
                                              style: Styles.headerText(
                                                  color: Colors.white),
                                              backColor:
                                            ...
                                            AppButton(
                                              label:
                                                  '${LocaleKeys.regular.localize} ${LocaleKeys.call.localize}',
