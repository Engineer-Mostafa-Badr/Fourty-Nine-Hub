...
class PastNonSocketTripsWidget extends StatefulWidget {
  ...
  const PastNonSocketTripsWidget({super.key, required this.tripEntity});

  @override
  State<PastNonSocketTripsWidget> createState() =>
      _PastNonSocketTripsWidgetState();
}
          ...
          children: [
            ...
            Expanded(
              child: PriceColumnNonSocket(
                ...
                price: formatPrice(
                    widget.tripEntity?.tripDetails?.price?.toInt() ?? 0.0,
                    context),
              ),
            ),
