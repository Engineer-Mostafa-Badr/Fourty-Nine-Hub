                        ...
                        child: Container(
                            ...
                            child: Padding(
                                ...
                                child: Row(children: [
                                  ...
                                  const Sizer(width: 4),
                                  Label(
                                      text: widget.offers?.clientDetails?.rating?.count.toString() ?? '0',
                          ...
                          widget: Center(
                            child: Row(
                              ...
                              children: [
                                Flexible(
                                  child: Label(
                                    text: "${LocaleKeys.Accept.tr()} ${widget.offers?.tripDetails?.price ?? 0}",
...
/*
class AvailableNonSocketLoadingWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    DateTime dateTime = DateTime.parse(
        offers?.createdAt ?? '2025-03-11T21:50:21.998Z');
    String formattedDate =
        "${dateTime.day.toString().padLeft(2, '0')}/${dateTime.month.toString().padLeft(2, '0')}/${dateTime.year}";
    String formattedTime =
        "${dateTime.hour % 12 == 0 ? 12 : dateTime.hour % 12} ${dateTime.hour < 12 ? 'AM' : 'PM'}";
