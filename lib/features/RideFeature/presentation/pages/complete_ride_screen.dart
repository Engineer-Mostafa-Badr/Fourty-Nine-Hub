                   ...
                   Row(children: [
                     ...
                     Expanded(
                       child: Container(
                         ...
                         child: Text(LocaleKeys.reportClient.localize,style:const TextStyle(
                        ...
                        Padding(padding: EdgeInsets.all(12)
                          ,child: Row(children: [
                            Text("100 Egy",style: TextStyle(color: Colors.red,fontSize: FontSize.s16),)
                        ...
                        Container(
                          ...
                          child: Text(LocaleKeys.completeRide.localize,style:const TextStyle(
                            fontSize: FontSize.s16,
                            fontWeight: FontWeight.bold,
                            color: AppColors.PRIMARY_COLOR_DARK,
                          ),),
