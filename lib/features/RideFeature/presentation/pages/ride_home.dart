              ...
              child: GestureDetector(
                onTap: () {
                  if ((driverInfo == null ||
                          (driverInfo.driverType?.isEmpty ?? false)) &&
                      (loadingInfo == null ||
                          (loadingInfo.status?.isEmpty ?? false))) {
                    openDrawer();
                  } else if ((driverInfo != null &&
                          (driverInfo.driverType?.isNotEmpty ?? false)) &&
                      (loadingInfo != null &&
                          (loadingInfo.status?.isNotEmpty ?? false))) {
                    openDrawer();
                  } else {
                    if ((driverInfo != null &&
                            (driverInfo.driverType?.isNotEmpty ?? false)) &&
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: ((driverInfo != null &&
                                  (driverInfo.driverType?.isNotEmpty ??
                                      false)) ||
                              (loadingInfo != null &&
                                  (loadingInfo.status?.isNotEmpty ?? false)))
                          ? [
                    ...
                    children: [
                      ...
                      if (!context.read<RideCubit>().selectedCategoryIsSocket)
                        RidePersonalMoreInfoScreen(
                            ...
                            type:
                                context.read<RideCubit>().state.selectedType ??
                                    'ride'),
                      context.read<RideCubit>().selectedCategoryIsSocket
                                                    ...
                                                    builder:
                                                      ...
                                                      return Padding(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Form(
                                                            key:
                                                                _phoneNumberFormKey, // Use the class-level key
                                                            child: Column(
                                                              mainAxisSize:
                                                                  MainAxisSize
                                                                      .min,
                                                              children: [
                                                                ...
                                                                NewPhoneNumberTextFormField(
                                                                  currentController:
                                                                      serviceLocator<
                                                                              RideCubit>()
                                                                          .phoneNumberController, // Use the class-level controller
                                                                  keyboardType:
                                                                      TextInputType
                                                                          .number,
                                                                  isRequired:
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      if (_phoneNumberFormKey
                                                                        ...
                                                                        Navigator.of(context)
                                                                            .pop(true); // Pass true if validated
                                                                      }
                                                                    },
