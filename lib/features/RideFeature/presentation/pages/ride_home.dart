                  ...
                  body: NestedAppbar(
                    ...
                    body: Stack(
                      children: [
                        ...
                        state.requestedTrip == null ? _carTruckBtn(driverInfo: state.driverInfo,loadingInfo: state.loaderInfo) : state.requestedTrip!.status == TripState.completed.name || state.requestedTrip!.status == TripState.canceled.name ? _carTruckBtn(driverInfo: state.driverInfo,loadingInfo: state.loaderInfo) : const SizedBox.shrink(),
                      ],
                    ),
                  ),
                ),
                ...
                Expanded(
                  child: Badge(
                    ...
                    child: ClickableWidget(
                        ...
                        child: _tripsWidget(context.isArabic? "عروض الرحلات": "Ride Offers", color: const Color(0xffD9D9D9))),
                  ),
                ),
                Expanded(
                  child: Badge(
                    ...
                    child: ClickableWidget(
                        ...
                        child: _tripsWidget(context.isArabic? "عروض التحميل": "Loading Offers", color: const Color(0xffD9D9D9))),
                  ),
                ),
              ],
            ),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        state.rideExpectedPrice != null ? Text(context.read<RideCubit>().getTotalPrice(selectedCategoryPrice).toInt().toString()) : Text(LocaleKeys.offerYourFare.tr()),
                        const Spacer(),
