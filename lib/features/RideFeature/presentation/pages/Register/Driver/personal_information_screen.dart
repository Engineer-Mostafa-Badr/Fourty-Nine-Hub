                      ...
                      children: [
                        ...
                        if (state.isShipping != true) ...[
                          DatePickerTextField(
                            ...
                            hintText:
                                LocaleKeys.user_info_date_of_birth.localize,
                          ),
                          const Sizer()
                        ],
                        DefaultTextFormField(
                        ...
                        if (state.isShipping != true) ...[
                          DefaultTextFormField(
                            currentController:
                                cubit.ridePersonalDocLicenseNumController,
                            fillColor: AppColors.GREYBG,
                            borderColor: Colors.transparent,
                        ...
                        if (state.registerType == 'socket') ...[
                          RegisterExpansionTile(
                            title: (state.selectedColors != null ||
                                    (state.selectedColors?.id.isNotEmpty ??
                                        false))
                                ? Row(
                                    children: [
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          color: HexColor(
                                              state.selectedColors?.code ?? ''),
                                        ),
                                      ),
                                      const Sizer(),
                                      Label(
                                        text: context.isArabic
                                            ? state.selectedColors?.nameAr ?? ''
                                            : state.selectedColors?.nameEn ??
                                                '',
                                      )
                                    ],
                                  )
                          ...
                          RegisterExpansionTile(
                            ...
                            onChange: (selectedItem) {
                              cubit.onSelectBrand(
                                  (selectedItem as Label).text, context);
                            },
                            length: state.brands?.length ?? 0,
                            children: List.generate(
                                state.brands?.length ?? 0,
                                (index) =>
                                    Label(text: state.brands?[index] ?? '')),
                          ),
                          const Sizer(),
                        ...
                        if (state.registerType == 'socket') ...[
                          ...
                          DefaultTextFormField(
                            currentController:
                                cubit.rideVehicleLicenseNumController,
                          ...
                          RegisterExpansionTile(
                            ...
                            children: List.generate(
                                ...
                                (index) => Label(
                                    text: cubit.subscriptionPlans[index])),
                          ),
                          const Sizer(),
                          DefaultTextFormField(
                            ...
                            validator: (v) {
                              if (v == null || v.isEmpty) {
                                ...
                                if ((num.tryParse(v) ?? 0) >
                                        (state.costPerKm?.highCostPerKm ?? 0) ||
                                    (num.tryParse(v) ?? 0) <
                                        (state.costPerKm?.lowCostPerKm ?? 0)) {
                          ...
                          RegisterExpansionTile(
                            title: Label(
                              text: (state.selectedGov != null ||
                                      (state.selectedGov?.isNotEmpty ?? false))
                                  ? state.selectedGov ?? ''
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        state.isShipping == true
                            ? cubit.onLoadingRegister(context)
                            : state.registerType == 'socket'
                                ? cubit.onRegister(context)
                                : cubit.onNoSocketRegister(context);
                      },
                      child: Container(
                        height: 44,
