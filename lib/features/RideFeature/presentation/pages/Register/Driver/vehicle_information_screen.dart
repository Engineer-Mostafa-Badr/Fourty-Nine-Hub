                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                (index) => UploadFileWidget(
                                  ...
                                  onTap: () {
                                    if (index == 0) {
                                      ...
                                      cubit
                                          .onUploadVehicleFrontPicture(context);
                                    } else {
                          ...
                          DatePickerTextField(
                            ...
                            onDateSelected: (date) {
                              cubit.rideVehicleExpireDateController.text =
                                  DateFormat('yyyy-MM-dd')
                                      .format(date ?? DateTime.now());
                            },
                            controller: cubit.rideVehicleExpireDateController,
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      ...
                      if (context
                          .read<RideCubit>()
                          .driverLicenseFormKey
                          .currentState!
                          .validate()) {
                        print("object");
                        if (context.read<RideCubit>().state.vehiclePicture ==
                            null) {
                          showErrorMessage(
                              context, "Please select vehicle picture");
                          return;
                        }
                        if (context
                                .read<RideCubit>()
                          ...
                          showErrorMessage(context,
                              "Please select front of vehicle license picture");
                          return;
                        }
                        if (context
                                .read<RideCubit>()
                            ...
                            null) {
                          showErrorMessage(context,
                              "Please select back of vehicle license picture");
                          return;
                        }
                        context
                            .read<RideCubit>()
                            .onSubmitUploadingCarLicense(context);
