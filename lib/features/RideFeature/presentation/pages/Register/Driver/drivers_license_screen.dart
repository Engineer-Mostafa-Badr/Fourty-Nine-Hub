...
class DriversLicenseScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScaffold(
      ...
      body: BlocBuilder<RideCubit, RideState>(builder: (context, state) {
        return Column(
          children: [
            Expanded(
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            child: GridView.count(
                              ...
                              children: List.generate(
                                ...
                                (index) => UploadFileWidget(
                                  title: state.isShipping == true
                                      ? uploadLoadingFilesTitles[index]
                                      : uploadFilesTitles[index],
                                  onTap: () {
                                    if (index == 0) {
                                      cubit.onUploadDriverLicensePicture(
                                          context);
                                    } else if (index == 1) {
                                      cubit.onUploadBackOfDriverLicensePicture(
                                          context);
                                    } else {
                                      cubit.onUploadSelfieDriverLicensePicture(
                                          context);
                                    }
                                  },
                                  imageUrl: index == 0
                                      ? state.driverLicensePicture
                                      : index == 1
                                          ? state.backOfDriverLicensePicture
                                          : state.selfieDriverLicensePicture,
                                ),
                              ),
                            ),
                          ),
                          ...
                          DatePickerTextField(
                            ...
                            onDateSelected: (date) {
                              cubit.rideDriverExpireDateController.text =
                                  DateFormat('yyyy-MM-dd')
                                      .format(date ?? DateTime.now());
                            },
                            controller: cubit.rideDriverExpireDateController,
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      ...
                      context
                          .read<RideCubit>()
                          .onSubmitUploadingDriverLicense(context);
                    },
                    child: Container(
                      height: 44,
