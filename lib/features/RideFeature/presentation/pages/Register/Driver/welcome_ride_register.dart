        ...
        return Column(
          children: [
                        ...
                        child: GridView.count(
                          ...
                          children: List.generate(
                            state.isShipping == true
                                ? state.shippingSubCategories
                                        ?.where((e) => e.isEnabled == true)
                                        .toList()
                                        .length ??
                                    0
                                : state.rideSubCategories
                                        ?.where((e) => e.isEnabled == true)
                                        .toList()
                                        .length ??
                                    0,
                            (index) {
                              var list = state.isShipping == true
                                  ? state.shippingSubCategories
                                      ?.where((e) => e.isEnabled == true)
                                      .toList()
                                  : state.rideSubCategories
                              ...
                              return InkWell(
                                onTap: () {
                                  if (state.isShipping == true) {
                                    cubit.onSelectShippingSubCategory(
                                        subCategory?.subCategoryId ?? '',
                                        context);
                                  } else {
                                    cubit.onSelectSubCategory(
                                        subCategory?.subCategoryId ?? '',
                                        context);
                                  }
                                },
            ...
            RegisterNextRow(
              onTap: () {
                if (state.isShipping == true) {
                  if (state.shippingSubCategories
