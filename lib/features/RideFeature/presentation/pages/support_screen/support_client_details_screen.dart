        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              CustomSupportTextField(hintText: LocaleKeys.enterYourName.localize, controller: nameController),
              SizedBox(height: 16),
              _buildLabel(LocaleKeys.clientPhone.localize),
              CustomSupportTextField(hintText: LocaleKeys.enterYourPhoneNumber.localize, controller: phoneController),
              SizedBox(height: 16),
              _buildLabel(LocaleKeys.email.localize),
              CustomSupportTextField(hintText: LocaleKeys.enterYourEmail.localize, controller: emailController),
              SizedBox(height: 16),
              _buildLabel(LocaleKeys.deviceID.localize),
              CustomSupportTextField(hintText: LocaleKeys.enterYourDeviceID.localize, controller: deviceIdController),
              SizedBox(height: 30),
              ElevatedButton.icon(
                onPressed: () {
