...
//   // final bool isTruk;
//
//   const RideLoadingRequestScreen({
//     super.key,
//   });
//
//   @override
//   State<RideLoadingRequestScreen> createState() =>
//       _RideLoadingRequestScreenState();
// }
//
...
//                       )
//                     : state.clientPendingTripData == null ||
//                             state.clientPendingTripData!.isEmpty
//                         ? const Center(
//                             child: Label(
...
//                             child: state.clientPendingTripData == null ||
//                                     state.clientPendingTripData!.isEmpty
//                                 ? const EmptyPage()
//                                 : ListView.separated(
...
//                                     itemCount:
//                                         state.clientPendingTripData?.length ??
//                                             0),
//                           );
//           },
//         ),
...
//           color: AppColors.cF5F5F5, borderRadius: BorderRadius.circular(20)),
//       child: Row(
