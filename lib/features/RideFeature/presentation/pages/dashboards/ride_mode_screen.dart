  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: CustomScaffold(
        ...
        appBar: BackAppBar(label: widget.params.modeType == "ride"
            ? LocaleKeys.rideMode.tr():LocaleKeys.trukMode.tr()),
                      ...
                      children: [
                        ...
                        if (widget.params.isSocket == true)
                          _buildTabItem(
                            cubit.state.currentIndex ?? 0,
                            8,
                            context.isArabic?'الرحلات':'Trips',
                                () {
                              ManageVibration.vibrate();
                              cubit.changeIndex(8, context, widget.params);
                              // setState(() {
                              //   _selectedIndex = 1;
                              // });
                            },
