    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      widget.params.isSocket == true
          ? [
              ...
              dashboardCubit.listenToAcceptOffer(),
          ...
          body: NestedAppbar(
            ...
            body: BlocConsumer<DashboardsCubit, DashboardsState>(
              listener: (context, state) {
                ...
                // }
                // if (state.status == DashboardsStates.successOffer &&
                //     state.createNonTrackOfferEntity != null &&
                //     state.offerCreatedShown == false) {
                //
                //   final message = state.createNonTrackOfferEntity?.message ?? "Offer created successfully";
                //
                ...
                //   );
                //
                //   context.read<DashboardsCubit>().clearCreateOfferState();
                // }
              },
