...
class DriversLicenseNonSocketScreen extends StatelessWidget {
  const DriversLicenseNonSocketScreen({super.key,});
                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // ),
                              const Sizer(),
                              DatePickerTextField(color:context.isDarkMode
                                  ?AppColors.GREY_DARK_COLOR:AppColors.GREYBG,initialDate: DateTime.now(), minDate: DateTime(1900), maxDate: DateTime(2090),onDateSelected: (date){
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        print("object");
                        context.read<DashboardsCubit>().onSubmitUploadingDriverLicense(context);
                      },
                      child: Container(
                        height: 44,
