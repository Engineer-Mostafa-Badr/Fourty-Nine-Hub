...
//       ),
//
//       // Client view with existing rating
//       if (isClient && isRate)
//         const SizedBox(width: 8),
//       if (isClient && isRate)
//         Flexible(child: _buildRatingDisplay(context)),
//
//       // Non-client view with existing rating
//       if (!isClient && isRate)
//         const SizedBox(width: 8),
//       if (!isClient && isRate)
//         Flexible(child: _buildRatingWithModify(context)),
//
//       // No rating view
//       if (!isRate && !isClient)
//         const SizedBox(width: 8),
...
// }
//
// Widget _buildRatingWithModify(BuildContext context) {
//   return Row(
//     mainAxisSize: MainAxisSize.min,
//     children: [
//       Flexible(child: _buildRatingDisplay(context)),
...
//             ),
//             child: Text(
//               LocaleKeys.modify.localize + 'wwwwwwwwwwwwwwwwwwwww',
//               overflow: TextOverflow.ellipsis,
//               maxLines: 1,
//               softWrap: false,
//               style: const TextStyle(
