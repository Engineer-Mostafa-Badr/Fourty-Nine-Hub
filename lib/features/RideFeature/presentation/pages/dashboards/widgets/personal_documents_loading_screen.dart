...
class PersonalDocumentsLoadingScreen extends StatelessWidget {
  const PersonalDocumentsLoadingScreen({super.key, });
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<DashboardsCubit, DashboardsState>(
      ...
      ManageVibration.vibrate();
                        print("object");
                        context.read<DashboardsCubit>().onSubmitUploadingIdLoading(context,);
                      },
                      child: Container(
                        height: 44,
