      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              context.isArabic?'لست مستعد!':'You are not ready!',
              style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16),
            ),
            SizedBox(
              width: context.width / 1.3,
              child: Text(
                context.isArabic?'اذا كنت مستعدة، يرجى الذهاب إلى الإعدادات وتغيير حالتك':'If you are ready, please go to settings and change your status.',
