...
class _PastTripsWidgetState extends State<PastTripsWidget> {
  ...
  String formatDateLocalized(String dateString) {
    ...
    final formatter =
        DateFormat('MMM d - hh:mm a', context.isArabic ? 'ar' : 'en');
        ...
        child: Row(
          ...
          children: [
            CarContainer(
                ...
                image:
                    widget.tripEntity!.subCategory!.pictureUrl //Assets.redCar,
                ),
            ...
            Expanded(
              child: PriceColumn(
                  ...
                  price: FormatNumbers().convertNumberToLocalizedString(
            ...
            SizedBox(
              ...
              child: Column(
                ...
                children: [
                  if (widget.tripEntity?.tripDetails?.clientRateDriver !=
                          null &&
                      widget.tripEntity?.tripDetails?.clientRateDriver != 0)
                    Container(
                  ...
                  Align(
                      ...
                      child: Image.asset(
                        widget.tripEntity?.clientDetails?.gender == 'male'
