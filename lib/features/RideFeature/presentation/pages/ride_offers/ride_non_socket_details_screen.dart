...
class RideNonSocketDetailsScreen extends StatefulWidget {
  const RideNonSocketDetailsScreen({super.key, required this.tripEntity,});
final ClientPastTripEntity tripEntity;
  @override
  State<RideNonSocketDetailsScreen> createState() =>
      _RideNonSocketDetailsScreenState();
}

class _RideNonSocketDetailsScreenState
    extends State<RideNonSocketDetailsScreen> {
  ...
  initState(){
    ...
    currentTripRating = widget.tripEntity.tripDetails?.yourRateDriver?.rate?.toDouble();
    super.initState();
  }
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Label(
                              text: widget.tripEntity.tripDetails?.location?.fromTitle ?? "",
                              style: const TextStyle(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Label(
                              text: widget.tripEntity.tripDetails?.location?.toTitle ?? "",
                              style: const TextStyle(
                                fontWeight: FontWeight.w600,
                                fontSize: 12,
                              ),
                  ...
                  RideDetailsRatingNonSocketClientWidget(
                    ...
                    // rate: 2,
                    rate: widget.tripEntity.tripDetails?.driverRateYou?.rate?.toDouble()?? 0.0,
