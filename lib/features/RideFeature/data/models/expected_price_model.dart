...
class RideExpectedPriceModel extends RideExpectedPriceEntity {
  RideExpectedPriceModel({
    required super.priceForWomen,
    required super.priceForTaxi,
    required super.priceForScooter,
    required super.priceForCaptain,
    required super.priceForPremium,
    required super.priceForIntercity,
    required super.priceForSUV,
    ...
    required super.comfort,
    required super.type,
    required super.autoAccept,
    required super.nonSmoking,
    required super.subcategoryModel,
  ...
  factory RideExpectedPriceModel.fromJson(Map<String, dynamic> json) {
    ...
    return RideExpectedPriceModel(
      calculateB: (json['calculate_b'] ?? 0).toDouble(),
      ...
      subcategoryModel: (json['subcategory'] as List?)
