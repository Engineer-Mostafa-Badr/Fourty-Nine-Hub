...
class LoadingInfoModel extends LoadingInfoEntity{
  LoadingInfoModel({required super.isApproved,required super.isUploadDriverImage,required super.status, required super.isUploadDriverId, required super.isUploadDriverLicense, required super.isUploadCarImage, required super.isUploadCarLicense});
