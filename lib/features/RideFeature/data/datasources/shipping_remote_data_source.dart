...
abstract class ShippingRemoteDataSource {
  ...
  Future<Either<Failure, CreateLoadingTripModel>> createLoadingTrip(
...
class ShippingRemoteDataSourceImplementation
  ...
  @override
  Future<Either<Failure, CreateLoadingTripModel>> createLoadingTrip(
      CreateLoadingTripModel params) async {
    try {
      ...
      return result.fold(
            ...
            (response) {
          final ladingTrip = response['data'];
          return Right(CreateLoadingTripModel.fromJson(ladingTrip));
        },
      );
    } catch (e) {
      return Left(ServerFailure(message: e.toString()));
