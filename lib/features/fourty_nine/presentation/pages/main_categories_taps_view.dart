...
class _MainCategoriesGridViewState extends State<MainCategoriesGridView> with TickerProviderStateMixin{
  @override
                ...
                return SizedBox(
                  ...
                  child: TabBar(
                    isScrollable: true,
                      ...
                      controller: TabController(length: controller.mainCategories.length, vsync: this),
                      tabs: List.generate(controller.mainCategories.length, (index) {
                    final category = controller.mainCategories[index];
                    return Container(
                      // constraints: const BoxConstraints(
                      //   minWidth: 120,
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return SubCategoryCard(
                          ...
                          item: subCategory, onFav: () {
                            print("object");
                            return controller.toggleSubCategoryToFavorites(state.subCategories![index].id);
                          },
                        );
                      },
                    ),
